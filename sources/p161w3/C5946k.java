...
public final class C5946k {
    ...
    public static int m35048a(java.lang.String r19) {
        /*
            r0 = -1
            if (r19 != 0) goto L_0x0004
            return r0
        L_0x0004:
            java.lang.String r1 = p161w3.C5967v.m35256t(r19)
            r1.hashCode()
            int r2 = r1.hashCode()
            r3 = 16
            r4 = 15
        ...
        L_0x0196:
            return r18
        */
        throw new UnsupportedOperationException("Method not decompiled: p161w3.C5946k.m35048a(java.lang.String):int");
    }

    /* renamed from: b */
    public static int m35049b(Map<String, List<String>> map) {
        List list = map.get("Content-Type");
        return m35048a((list == null || list.isEmpty()) ? null : (String) list.get(0));
    }

    /* renamed from: c */
    public static int m35050c(Uri uri) {
