...
class C10702a {
    ...
    /* renamed from: a */
    private final FlutterJNI f41937a;

    public C10702a(FlutterJNI flutterJNI) {
        this.f41937a = flutterJNI;
    }
    ...
    public int mo34148a(java.lang.CharSequence r10, int r11) {
        /*
            r9 = this;
            int r0 = r10.length()
            int r1 = r0 + -1
        ...
        L_0x0067:
            ...
            boolean r0 = r9.mo34156i(r1)
            if (r0 == 0) goto L_0x0091
            int r10 = java.lang.Character.codePointAt(r10, r4)
            boolean r0 = r9.mo34153f(r10)
        ...
        L_0x013b:
            if (r6 == 0) goto L_0x0143
            boolean r8 = r9.mo34150c(r2)
            if (r8 != 0) goto L_0x00a6
        L_0x0143:
            int r11 = r11 + r3
            return r11
        */
        throw new UnsupportedOperationException("Method not decompiled: p264io.flutter.plugin.editing.C10702a.mo34148a(java.lang.CharSequence, int):int");
    }
    ...
    /* renamed from: b */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public int mo34149b(java.lang.CharSequence r9, int r10) {
        /*
            r8 = this;
            r0 = 0
            r1 = 1
        ...
        L_0x004d:
            ...
            boolean r1 = r8.mo34156i(r0)
            if (r1 == 0) goto L_0x0077
            int r9 = java.lang.Character.codePointBefore(r9, r4)
            boolean r1 = r8.mo34153f(r9)
        ...
        L_0x00d6:
            ...
            r5 = 0
        L_0x00e0:
            boolean r6 = r8.mo34151d(r2)
            if (r6 == 0) goto L_0x0117
            int r1 = java.lang.Character.codePointBefore(r9, r4)
            int r2 = java.lang.Character.charCount(r1)
            int r4 = r4 - r2
            if (r4 <= 0) goto L_0x010a
            boolean r2 = r8.mo34156i(r1)
            if (r2 == 0) goto L_0x010a
            int r1 = java.lang.Character.codePointBefore(r9, r4)
            boolean r9 = r8.mo34150c(r1)
        ...
        L_0x014c:
            if (r5 == 0) goto L_0x0154
            boolean r7 = r8.mo34150c(r2)
            if (r7 != 0) goto L_0x00d6
        L_0x0154:
            int r10 = r10 - r3
            return r10
        */
        throw new UnsupportedOperationException("Method not decompiled: p264io.flutter.plugin.editing.C10702a.mo34149b(java.lang.CharSequence, int):int");
    }

    /* renamed from: c */
    public boolean mo34150c(int i) {
        return this.f41937a.isCodePointEmoji(i);
    }

    /* renamed from: d */
    public boolean mo34151d(int i) {
        return this.f41937a.isCodePointEmojiModifier(i);
    }

    /* renamed from: e */
    public boolean mo34152e(int i) {
        return this.f41937a.isCodePointEmojiModifierBase(i);
    }

    /* renamed from: f */
    public boolean mo34153f(int i) {
        return (48 <= i && i <= 57) || i == 35 || i == 42;
    }

    /* renamed from: g */
    public boolean mo34154g(int i) {
        return this.f41937a.isCodePointRegionalIndicator(i);
    }

    /* renamed from: h */
    public boolean mo34155h(int i) {
        return 917536 <= i && i <= 917630;
    }

    /* renamed from: i */
    public boolean mo34156i(int i) {
        return this.f41937a.isCodePointVariantSelector(i);
    }
}
