...
@Deprecated
public class XiaomiHomeBadger implements C11778a {

    /* renamed from: a */
    private ResolveInfo f36030a;

    /* renamed from: c */
    private void m47697c(Context context, int i) throws C11779b {
        if (this.f36030a == null) {
            Intent intent = new Intent("android.intent.action.MAIN");
            intent.addCategory("android.intent.category.HOME");
            this.f36030a = context.getPackageManager().resolveActivity(intent, 65536);
        }
        if (this.f36030a != null) {
            NotificationManager notificationManager = (NotificationManager) context.getSystemService("notification");
            Notification build = new Notification.Builder(context).setContentTitle("").setContentText("").setSmallIcon(this.f36030a.getIconResource()).build();
            try {
                ...
                throw new C11779b("not able to set badge", e);
            }
        }
    }
    ...
    public void mo28205b(android.content.Context r5, android.content.ComponentName r6, int r7) throws p287la.C11779b {
        /*
            r4 = this;
            java.lang.String r0 = ""
        ...
        L_0x0062:
            ...
            r1.putExtra(r0, r6)
            boolean r6 = p296ma.C11875a.m57372a(r5, r1)
        ...
        L_0x0081:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.onesignal.shortcutbadger.impl.XiaomiHomeBadger.mo28205b(android.content.Context, android.content.ComponentName, int):void");
    }
}
