...
public interface InAppWebViewInterface {
    ...
    void postWebMessage(WebMessage webMessage, Uri uri, ValueCallback<String> valueCallback) throws Exception;
    ...
    void takeScreenshot(Map<String, Object> map, C6556k.C6561d dVar);
