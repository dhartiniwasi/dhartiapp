...
public class WebMessagePort {
    ...
    public void close(final ValueCallback<Void> valueCallback) throws Exception {
        ...
        if (!this.isTransferred) {
            ...
            if (inAppWebViewInterface != null) {
                inAppWebViewInterface.evaluateJavascript("(function() {  var webMessageChannel = window.flutter_inappwebview._webMessageChannels['" + this.webMessageChannel.f36286id + "'];  if (webMessageChannel != null) {      webMessageChannel." + this.name + ".close();  }})();", (ContentWorld) null, new ValueCallback<String>() {
    ...
    public void postMessage(WebMessage webMessage, final ValueCallback<Void> valueCallback) throws Exception {
        ...
        if (inAppWebViewInterface != null) {
            ...
            if (list != null) {
                ...
                for (WebMessagePort next : list) {
                    if (next == this) {
                        ...
                        arrayList.add("window.flutter_inappwebview._webMessageChannels['" + this.webMessageChannel.f36286id + "']." + next.name);
                    }
                }
            ...
            inAppWebViewInterface.evaluateJavascript("(function() {  var webMessageChannel = window.flutter_inappwebview._webMessageChannels['" + this.webMessageChannel.f36286id + "'];  if (webMessageChannel != null) {      webMessageChannel." + this.name + ".postMessage('" + str2 + "', " + str + ");  }})();", (ContentWorld) null, new ValueCallback<String>() {
                public void onReceiveValue(String str) {
                    valueCallback.onReceiveValue((Object) null);
                }
            });
    ...
    public void setWebMessageCallback(final ValueCallback<Void> valueCallback) throws Exception {
        ...
        if (inAppWebViewInterface != null) {
            inAppWebViewInterface.evaluateJavascript("(function() {  var webMessageChannel = window.flutter_inappwebview._webMessageChannels['" + this.webMessageChannel.f36286id + "'];  if (webMessageChannel != null) {      webMessageChannel." + this.name + ".onmessage = function (event) {          window." + JavaScriptBridgeJS.JAVASCRIPT_BRIDGE_NAME + ".callHandler('onWebMessagePortMessageReceived', {              'webMessageChannelId': '" + this.webMessageChannel.f36286id + "',              'index': " + (true ^ this.name.equals("port1") ? 1 : 0) + ",              'message': event.data          });      }  }})();", (ContentWorld) null, new ValueCallback<String>() {
                public void onReceiveValue(String str) {
