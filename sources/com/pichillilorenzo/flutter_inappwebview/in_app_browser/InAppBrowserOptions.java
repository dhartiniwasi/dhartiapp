...
public class InAppBrowserOptions implements Options<InAppBrowserActivity> {
    ...
    public Map<String, Object> getRealOptions(InAppBrowserActivity inAppBrowserActivity) {
        ...
        boolean z = true;
        map.put("hideToolbarTop", Boolean.valueOf(!inAppBrowserActivity.actionBar.mo848m()));
        map.put("hideUrlBar", Boolean.valueOf(!inAppBrowserActivity.menu.findItem(C8710R.C8712id.menu_search).isVisible()));
