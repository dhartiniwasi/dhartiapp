...
public class RewardedInterstitialAd implements FullScreenAd {
    ...
    @Keep
    public interface RewardedInterstitialAdLoadConfigBuilder extends C1969Ad.LoadConfigBuilder {
    ...
    @Keep
    public interface RewardedInterstitialLoadAdConfig extends C1969Ad.LoadAdConfig {
    }
