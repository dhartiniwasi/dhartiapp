...
public class DexLoadErrorReporter {
    ...
    /* renamed from: a */
    private static final AtomicBoolean f5670a = new AtomicBoolean();

    /* renamed from: com.facebook.ads.internal.dynamicloading.DexLoadErrorReporter$a */
    class C1988a extends Thread {
        ...
        C1988a(Context context, String str) {
            this.f5671a = context;
            this.f5672b = str;
        }
        ...
        public void run() {
            /*
                ...
                android.content.Context r12 = r1.f5671a     // Catch:{ all -> 0x0156 }
                com.facebook.ads.internal.dynamicloading.DexLoadErrorReporter.m8689b(r12, r11, r10)     // Catch:{ all -> 0x0156 }
                ...
                java.lang.String r14 = r1.f5672b     // Catch:{ all -> 0x0156 }
                r12.put(r13, r14)     // Catch:{ all -> 0x0156 }
                ...
                android.content.Context r2 = r1.f5671a     // Catch:{ all -> 0x0154 }
                com.facebook.ads.internal.dynamicloading.DexLoadErrorReporter.m8689b(r2, r12, r10)     // Catch:{ all -> 0x0154 }
            ...
            L_0x01a1:
                throw r2
            */
            throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.internal.dynamicloading.DexLoadErrorReporter.C1988a.run():void");
        }
    }

    /* access modifiers changed from: private */
    /* renamed from: b */
    public static void m8689b(Context context, JSONObject jSONObject, String str) throws JSONException, PackageManager.NameNotFoundException {
    ...
    public static void reportDexLoadingIssue(Context context, String str, double d) {
        AtomicBoolean atomicBoolean = f5670a;
        if (!atomicBoolean.get() && Math.random() < d) {
            atomicBoolean.set(true);
            new C1988a(context, str).start();
        }
    }
}
