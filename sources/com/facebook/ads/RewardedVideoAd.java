...
public class RewardedVideoAd implements FullScreenAd {
    ...
    @Keep
    public interface RewardedVideoAdLoadConfigBuilder extends C1969Ad.LoadConfigBuilder {
    ...
    @Keep
    public interface RewardedVideoLoadAdConfig extends C1969Ad.LoadAdConfig {
    }
