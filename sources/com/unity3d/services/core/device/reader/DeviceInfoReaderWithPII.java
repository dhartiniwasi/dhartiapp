...
public class DeviceInfoReaderWithPII implements IDeviceInfoReader {
    ...
    static /* synthetic */ class C98101 {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f39622x6a9b5bad     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f39622x6a9b5bad     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.unity3d.services.core.device.reader.DeviceInfoReaderWithPII.C98101.<clinit>():void");
        }
    }
    ...
    public Map<String, Object> getDeviceInfoData() {
        ...
        int i = C98101.f39622x6a9b5bad[whatToDoWithPII.getResultType().ordinal()];
        if (i == 1) {
