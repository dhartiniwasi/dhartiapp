...
public class DeviceInfo {
    ...
    static /* synthetic */ class C97882 {
        ...
        static {
            ...
            L_0x001d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.unity3d.services.core.api.DeviceInfo.C97882.<clinit>():void");
        }
    }
    ...
    private static File getFileForStorageType(StorageType storageType) {
        int i = C97882.$SwitchMap$com$unity3d$services$core$api$DeviceInfo$StorageType[storageType.ordinal()];
        if (i == 1) {
    ...
    public static void getTimeZoneOffset(WebViewCallback webViewCallback) {
        webViewCallback.invoke(Integer.valueOf(TimeZone.getDefault().getOffset(System.currentTimeMillis()) / AdError.NETWORK_ERROR_CODE));
    }
    ...
    public static void registerVolumeChangeListener(Integer num, WebViewCallback webViewCallback) {
        ...
        if (_volumeChangeListeners.get(num.intValue()) == null) {
            C97871 r0 = new IVolumeChangeListener(num) {
