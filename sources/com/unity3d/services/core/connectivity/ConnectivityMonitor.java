...
public class ConnectivityMonitor {
    ...
    static /* synthetic */ class C98051 {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f39620xede9def6     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f39620xede9def6     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.unity3d.services.core.connectivity.ConnectivityMonitor.C98051.<clinit>():void");
        }
    }
    ...
    private static void sendToWebview(ConnectivityEvent connectivityEvent, boolean z, int i) {
        ...
        if (_webappMonitoring && (currentApp = WebViewApp.getCurrentApp()) != null && currentApp.isWebAppLoaded()) {
            int i2 = C98051.f39620xede9def6[connectivityEvent.ordinal()];
            if (i2 != 1) {
                if (i2 == 2) {
