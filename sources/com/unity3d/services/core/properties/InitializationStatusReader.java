...
public class InitializationStatusReader {
    ...
    static /* synthetic */ class C98151 {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f39625xe3e1bbe9     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f39625xe3e1bbe9     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f39625xe3e1bbe9     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.unity3d.services.core.properties.InitializationStatusReader.C98151.<clinit>():void");
        }
    }

    public String getInitializationStateString(SdkProperties.InitializationState initializationState) {
        int i = C98151.f39625xe3e1bbe9[initializationState.ordinal()];
        if (i == 1) {
