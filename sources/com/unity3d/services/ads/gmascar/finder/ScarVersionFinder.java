...
public class ScarVersionFinder implements IInitializationStatusListener {
    ...
    public void findAndSendVersion(boolean z) {
        WebViewApp.getCurrentApp().sendEvent(WebViewEventCategory.INIT_GMA, C9696c.VERSION, z ? _mobileAdsBridge.getVersionString() : "0.0.0");
    }
    ...
    public void getVersion() {
        try {
            if (!this._presenceDetector.areGMAClassesPresent()) {
                WebViewApp.getCurrentApp().sendEvent(WebViewEventCategory.INIT_GMA, C9696c.VERSION, "0.0.0");
