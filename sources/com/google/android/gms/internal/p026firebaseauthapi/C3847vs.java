...
import p293m7.C11824h;
import p293m7.C11830j;
import p293m7.C11841m1;

/* renamed from: com.google.android.gms.internal.firebase-auth-api.vs */
/* compiled from: com.google.firebase:firebase-auth@@21.1.0 */
public final class C3847vs {

    /* renamed from: a */
    static final SparseArray f22820a;
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:45:0x00c0, code lost:
        return new p246h7.C10409c(r1);
     */
    /* JADX WARNING: Code restructure failed: missing block: B:49:0x00d6, code lost:
        return new com.google.firebase.auth.C7859w(m27248d(r0), r1);
     */
    /* JADX WARNING: Code restructure failed: missing block: B:51:0x00e0, code lost:
        return new com.google.firebase.auth.C7841q(m27248d(r0), r1);
     */
    /* renamed from: a */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static p246h7.C10421l m27245a(com.google.android.gms.common.api.Status r3) {
        /*
            int r0 = r3.mo7950J1()
            java.lang.String r1 = m27250f(r0)
            java.lang.String r1 = m27249e(r1, r3)
        ...
        L_0x0041:
            ...
            java.lang.String r3 = m27249e(r0, r3)
            h7.m r0 = new h7.m
            r0.<init>(r3)
            return r0
        L_0x004d:
            com.google.firebase.auth.p r3 = new com.google.firebase.auth.p
            java.lang.String r0 = m27248d(r0)
            r3.<init>(r0, r1)
            return r3
        L_0x0057:
            ...
            return r3
        L_0x0061:
            com.google.firebase.auth.x r2 = new com.google.firebase.auth.x
            java.lang.String r0 = m27248d(r0)
            java.lang.String r3 = r3.mo7951K1()
            r2.<init>(r0, r1, r3)
            return r2
        L_0x006f:
        ...
        L_0x007b:
            ...
            return r0
        L_0x0087:
            com.google.firebase.auth.u r3 = new com.google.firebase.auth.u
            java.lang.String r0 = m27248d(r0)
            r3.<init>(r0, r1)
            return r3
        L_0x0091:
            com.google.firebase.auth.f2 r3 = new com.google.firebase.auth.f2
            java.lang.String r0 = m27248d(r0)
            r3.<init>(r0, r1)
            return r3
        L_0x009b:
            com.google.firebase.auth.g2 r3 = new com.google.firebase.auth.g2
            java.lang.String r0 = m27248d(r0)
            r3.<init>(r0, r1)
            return r3
        L_0x00a5:
            java.lang.String r3 = m27249e(r2, r3)
            h7.l r0 = new h7.l
            r0.<init>(r3)
            return r0
        L_0x00af:
        ...
        L_0x00c1:
            ...
            return r0
        L_0x00cd:
            com.google.firebase.auth.w r3 = new com.google.firebase.auth.w
            java.lang.String r0 = m27248d(r0)
            r3.<init>(r0, r1)
            return r3
        L_0x00d7:
            ...
            return r3
        L_0x00e1:
            com.google.firebase.auth.y r3 = new com.google.firebase.auth.y
            java.lang.String r0 = m27248d(r0)
            r3.<init>(r0, r1)
            return r3
        L_0x00eb:
        ...
        L_0x0105:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.p026firebaseauthapi.C3847vs.m27245a(com.google.android.gms.common.api.Status):h7.l");
    }

    /* renamed from: b */
    public static C10421l m27246b(Status status, C7806h hVar, String str, String str2) {
        int J1 = status.mo7950J1();
        if (J1 != 17012 && J1 != 17007 && J1 != 17025) {
            return m27245a(status);
        }
        C7859w wVar = new C7859w(m27248d(J1), m27249e(m27250f(J1), status));
        wVar.mo26201d(hVar);
        wVar.mo26202e(str);
        wVar.mo26203f(str2);
        return wVar;
    ...
    /* renamed from: c */
    public static C7850t m27247c(FirebaseAuth firebaseAuth, C3382hp hpVar, C7869z zVar) {
        Objects.requireNonNull(firebaseAuth);
        Objects.requireNonNull(hpVar);
        Pair pair = (Pair) f22820a.get(17078);
        String str = (String) pair.first;
        String str2 = (String) pair.second;
        Parcelable.Creator<C11824h> creator = C11824h.CREATOR;
        List<C7811i0> K1 = hpVar.mo16107K1();
        ArrayList arrayList = new ArrayList();
        for (C7811i0 i0Var : K1) {
            if (i0Var instanceof C7848s0) {
                arrayList.add((C7848s0) i0Var);
            }
        }
        return new C7850t(str, str2, new C11824h(arrayList, C11830j.m57244J1(hpVar.mo16107K1(), hpVar.mo16106J1()), firebaseAuth.mo26030l().mo33470q(), hpVar.mo16105I1(), (C11841m1) zVar));
    }

    /* renamed from: d */
    private static String m27248d(int i) {
        Pair pair = (Pair) f22820a.get(i);
        return pair != null ? (String) pair.first : "INTERNAL_ERROR";
    }

    /* renamed from: e */
    private static String m27249e(String str, Status status) {
        if (TextUtils.isEmpty(status.mo7951K1())) {
            return str;
        }
        return String.format(String.valueOf(str).concat(" [ %s ]"), new Object[]{status.mo7951K1()});
    }

    /* renamed from: f */
    private static String m27250f(int i) {
        Pair pair = (Pair) f22820a.get(i);
