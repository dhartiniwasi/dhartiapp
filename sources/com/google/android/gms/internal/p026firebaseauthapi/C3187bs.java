...
/* renamed from: com.google.android.gms.internal.firebase-auth-api.bs */
/* compiled from: com.google.firebase:firebase-auth@@21.1.0 */
final class C3187bs extends C3848vt {

    /* renamed from: w */
    private final C3480ko f21789w;

    public C3187bs(String str, String str2, String str3) {
        super(2);
        C4141r.m28218h(str, "email cannot be null or empty");
        C4141r.m28218h(str2, "password cannot be null or empty");
        this.f21789w = new C3480ko(str, str2, str3);
    }

    /* renamed from: a */
    public final void mo15756a(C9977j jVar, C3814us usVar) {
        this.f22842v = new C3815ut(this, jVar);
        usVar.mo16889C(this.f21789w, this.f22822b);
    }
