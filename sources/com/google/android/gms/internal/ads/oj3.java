...
public final class oj3 extends lj3 {
    public oj3(byte[] bArr, int i) throws InvalidKeyException {
        super(bArr, i);
    }
    ...
    public final int[] mo11717b(int[] iArr, int i) {
        ...
        if (length == 6) {
            ...
            hj3.m13876b(iArr3, this.f12820a);
            iArr3[12] = iArr[0];
            iArr3[13] = iArr[1];
            iArr3[14] = iArr[2];
            iArr3[15] = iArr[3];
            ...
            iArr3[6] = iArr3[14];
            iArr3[7] = iArr3[15];
            hj3.m13876b(iArr2, Arrays.copyOf(iArr3, 8));
            iArr2[12] = i;
            iArr2[13] = 0;
            iArr2[14] = iArr[4];
            iArr2[15] = iArr[5];
