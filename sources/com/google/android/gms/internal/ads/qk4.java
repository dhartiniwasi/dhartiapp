...
public final class qk4 implements mk4, ve3 {

    /* renamed from: A */
    public static final ua3 f16428A = ua3.m21500A(2800000L, 2400000L, 1600000L, 1100000L, 950000L);

    /* renamed from: B */
    private static qk4 f16429B;

    /* renamed from: v */
    public static final ua3 f16430v = ua3.m21500A(4800000L, 3100000L, 2100000L, 1500000L, 800000L);

    /* renamed from: w */
    public static final ua3 f16431w = ua3.m21500A(1500000L, 1000000L, 730000L, 440000L, 170000L);

    /* renamed from: x */
    public static final ua3 f16432x = ua3.m21500A(2200000L, 1400000L, 1100000L, 910000L, 620000L);

    /* renamed from: y */
    public static final ua3 f16433y = ua3.m21500A(3000000L, 1900000L, 1400000L, 1000000L, 660000L);

    /* renamed from: z */
    public static final ua3 f16434z = ua3.m21500A(6000000L, 4100000L, 3200000L, 1800000L, 1000000L);

    /* renamed from: a */
    private final xa3 f16435a;

    /* renamed from: b */
    private final kk4 f16436b = new kk4();

    /* renamed from: c */
    private final hl4 f16437c = new hl4(AdError.SERVER_ERROR_CODE);

    /* renamed from: d */
    private final wa1 f16438d;
    ...
    /* synthetic */ qk4(Context context, Map map, int i, wa1 wa1, boolean z, pk4 pk4) {
        this.f16435a = xa3.m23154d(map);
        this.f16438d = wa1;
        this.f16439e = true;
        if (context != null) {
            w02 b = w02.m22517b(context);
            int a = b.mo14853a();
            this.f16443i = a;
            this.f16446t = m19249e(a);
            b.mo14854d(new ok4(this));
            return;
        }
        this.f16443i = 0;
        this.f16446t = m19249e(0);
    }

    /* renamed from: c */
    public static synchronized qk4 m19247c(Context context) {
        qk4 qk4;
        ...
        synchronized (qk4.class) {
            if (f16429B == null) {
                ...
                int[] i = m19253i(gb2.m13178l(context));
                HashMap hashMap = new HashMap(8);
                hashMap.put(0, 1000000L);
                ua3 ua3 = f16430v;
                hashMap.put(2, (Long) ua3.get(i[0]));
                hashMap.put(3, (Long) f16431w.get(i[1]));
                hashMap.put(4, (Long) f16432x.get(i[2]));
                hashMap.put(5, (Long) f16433y.get(i[3]));
                hashMap.put(10, (Long) f16434z.get(i[4]));
                hashMap.put(9, (Long) f16428A.get(i[5]));
                hashMap.put(7, (Long) ua3.get(i[0]));
                f16429B = new qk4(context2, hashMap, AdError.SERVER_ERROR_CODE, wa1.f19542a, true, (pk4) null);
            }
            qk4 = f16429B;
        }
        return qk4;
    ...
    /* renamed from: e */
    private final long m19249e(int i) {
        Long l = (Long) this.f16435a.get(Integer.valueOf(i));
        if (l == null) {
            l = (Long) this.f16435a.get(0);
        }
        if (l == null) {
            l = 1000000L;
        }
    ...
    /* renamed from: f */
    private final void m19250f(int i, long j, long j2) {
        long j3;
        int i2;
        if (i == 0) {
            if (j != 0) {
                j3 = j;
            } else if (j2 != this.f16447u) {
                j3 = 0;
            } else {
                return;
            }
        ...
        this.f16447u = j2;
        this.f16436b.mo11719b(i2, j3, j2);
    }
    ...
    public final synchronized void m19251g(int r9) {
        /*
            r8 = this;
            monitor-enter(r8)
            int r0 = r8.f16443i     // Catch:{ all -> 0x004e }
            if (r0 == 0) goto L_0x000c
            boolean r1 = r8.f16439e     // Catch:{ all -> 0x004e }
        ...
        L_0x000c:
            ...
            return
        L_0x0010:
            r8.f16443i = r9     // Catch:{ all -> 0x004e }
            r0 = 1
            ...
            goto L_0x004c
        L_0x001c:
            long r0 = r8.m19249e(r9)     // Catch:{ all -> 0x004e }
            r8.f16446t = r0     // Catch:{ all -> 0x004e }
            long r0 = android.os.SystemClock.elapsedRealtime()     // Catch:{ all -> 0x004e }
            int r9 = r8.f16440f     // Catch:{ all -> 0x004e }
            if (r9 <= 0) goto L_0x0031
            long r2 = r8.f16441g     // Catch:{ all -> 0x004e }
            long r2 = r0 - r2
        ...
        L_0x0031:
            ...
            r3 = 0
        L_0x0033:
            long r4 = r8.f16442h     // Catch:{ all -> 0x004e }
            long r6 = r8.f16446t     // Catch:{ all -> 0x004e }
            r2 = r8
            r2.m19250f(r3, r4, r6)     // Catch:{ all -> 0x004e }
            r8.f16441g = r0     // Catch:{ all -> 0x004e }
            r0 = 0
            r8.f16442h = r0     // Catch:{ all -> 0x004e }
            r8.f16445s = r0     // Catch:{ all -> 0x004e }
            r8.f16444r = r0     // Catch:{ all -> 0x004e }
            com.google.android.gms.internal.ads.hl4 r9 = r8.f16437c     // Catch:{ all -> 0x004e }
            r9.mo10838c()     // Catch:{ all -> 0x004e }
            monitor-exit(r8)
            return
        L_0x004c:
            monitor-exit(r8)
        ...
        L_0x004e:
            ...
            throw r9
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.qk4.m19251g(int):void");
    }

    /* renamed from: h */
    private static boolean m19252h(wq2 wq2, boolean z) {
        return z && !wq2.mo14977b(8);
    }
    ...
    /* renamed from: i */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private static int[] m19253i(java.lang.String r3) {
        /*
            int r0 = r3.hashCode()
        ...
        L_0x0bd5:
            ...
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.qk4.m19253i(java.lang.String):int[]");
    }

    /* renamed from: A */
    public final synchronized void mo11191A(ql2 ql2, wq2 wq2, boolean z) {
        if (m19252h(wq2, z)) {
            v91.m22052f(this.f16440f > 0);
            long elapsedRealtime = SystemClock.elapsedRealtime();
            int i = (int) (elapsedRealtime - this.f16441g);
            this.f16444r += (long) i;
            long j = this.f16445s;
            long j2 = this.f16442h;
            this.f16445s = j + j2;
            if (i > 0) {
                this.f16437c.mo10837b((int) Math.sqrt((double) j2), (((float) j2) * 8000.0f) / ((float) i));
                if (this.f16444r >= 2000 || this.f16445s >= 524288) {
                    this.f16446t = (long) this.f16437c.mo10836a(0.5f);
                }
                m19250f(i, this.f16442h, this.f16446t);
                this.f16441g = elapsedRealtime;
                this.f16442h = 0;
            }
            this.f16440f--;
        }
    ...
    /* renamed from: a */
    public final void mo12368a(lk4 lk4) {
        this.f16436b.mo11720c(lk4);
    }

    /* renamed from: b */
    public final void mo12369b(Handler handler, lk4 lk4) {
        Objects.requireNonNull(lk4);
        this.f16436b.mo11718a(handler, lk4);
    }

    /* renamed from: o */
    public final synchronized void mo11234o(ql2 ql2, wq2 wq2, boolean z, int i) {
        if (m19252h(wq2, z)) {
            this.f16442h += (long) i;
        }
    }
    ...
    /* renamed from: r */
    public final synchronized void mo11237r(ql2 ql2, wq2 wq2, boolean z) {
        if (m19252h(wq2, z)) {
            if (this.f16440f == 0) {
                this.f16441g = SystemClock.elapsedRealtime();
            }
            this.f16440f++;
        }
    }
