...
public final class ee0 extends le0 {

    /* renamed from: u */
    static final Set f8756u = C4692f.m30384g("top-left", "top-right", "top-center", "center", "bottom-left", "bottom-right", "bottom-center");

    /* renamed from: c */
    private String f8757c = "top-right";

    /* renamed from: d */
    private boolean f8758d = true;
    ...
    /* renamed from: h */
    private int f8762h = 0;

    /* renamed from: i */
    private int f8763i = 0;

    /* renamed from: j */
    private int f8764j = -1;

    /* renamed from: k */
    private final Object f8765k = new Object();

    /* renamed from: l */
    private final vs0 f8766l;

    /* renamed from: m */
    private final Activity f8767m;
    ...
    /* renamed from: p */
    private LinearLayout f8770p;

    /* renamed from: q */
    private final me0 f8771q;

    /* renamed from: r */
    private PopupWindow f8772r;

    /* renamed from: s */
    private RelativeLayout f8773s;

    /* renamed from: t */
    private ViewGroup f8774t;

    public ee0(vs0 vs0, me0 me0) {
        super(vs0, "resize");
        this.f8766l = vs0;
        this.f8767m = vs0.mo8461X();
        this.f8771q = me0;
    }

    /* renamed from: h */
    public final void mo9890h(boolean z) {
        synchronized (this.f8765k) {
            PopupWindow popupWindow = this.f8772r;
            if (popupWindow != null) {
                popupWindow.dismiss();
                this.f8773s.removeView((View) this.f8766l);
                ViewGroup viewGroup = this.f8774t;
                if (viewGroup != null) {
                    viewGroup.removeView(this.f8769o);
                    this.f8774t.addView((View) this.f8766l);
                    this.f8766l.mo12100Z0(this.f8768n);
                }
                if (z) {
                    mo11988g("default");
                    me0 me0 = this.f8771q;
    ...
    public final void mo9891i(java.util.Map r18) {
        /*
            r17 = this;
            r1 = r17
            r0 = r18
            java.lang.Object r2 = r1.f8765k
            monitor-enter(r2)
            android.app.Activity r3 = r1.f8767m     // Catch:{ all -> 0x047d }
            if (r3 != 0) goto L_0x0012
            java.lang.String r0 = "Not an activity context. Cannot resize."
            r1.mo11984c(r0)     // Catch:{ all -> 0x047d }
            monitor-exit(r2)     // Catch:{ all -> 0x047d }
            return
        L_0x0012:
            com.google.android.gms.internal.ads.vs0 r3 = r1.f8766l     // Catch:{ all -> 0x047d }
            com.google.android.gms.internal.ads.mu0 r3 = r3.mo9698n()     // Catch:{ all -> 0x047d }
        ...
        L_0x0021:
            com.google.android.gms.internal.ads.vs0 r3 = r1.f8766l     // Catch:{ all -> 0x047d }
            com.google.android.gms.internal.ads.mu0 r3 = r3.mo9698n()     // Catch:{ all -> 0x047d }
            boolean r3 = r3.mo12442i()     // Catch:{ all -> 0x047d }
        ...
        L_0x0034:
            com.google.android.gms.internal.ads.vs0 r3 = r1.f8766l     // Catch:{ all -> 0x047d }
            boolean r3 = r3.mo12098X0()     // Catch:{ all -> 0x047d }
            ...
            p053g4.C4409t.m29326r()     // Catch:{ all -> 0x047d }
            java.lang.String r3 = "width"
            java.lang.Object r3 = r0.get(r3)     // Catch:{ all -> 0x047d }
            java.lang.String r3 = (java.lang.String) r3     // Catch:{ all -> 0x047d }
            int r3 = p073j4.C4751b2.m30616k(r3)     // Catch:{ all -> 0x047d }
            r1.f8764j = r3     // Catch:{ all -> 0x047d }
        L_0x005b:
        ...
        L_0x00d4:
            ...
            r1.f8757c = r0     // Catch:{ all -> 0x047d }
        L_0x00e4:
            int r0 = r1.f8764j     // Catch:{ all -> 0x047d }
            if (r0 < 0) goto L_0x046f
            int r0 = r1.f8761g     // Catch:{ all -> 0x047d }
            if (r0 < 0) goto L_0x046f
            android.app.Activity r0 = r1.f8767m     // Catch:{ all -> 0x047d }
        ...
        L_0x00fc:
            p053g4.C4409t.m29326r()     // Catch:{ all -> 0x047d }
            android.app.Activity r3 = r1.f8767m     // Catch:{ all -> 0x047d }
            int[] r3 = p073j4.C4751b2.m30623r(r3)     // Catch:{ all -> 0x047d }
            p053g4.C4409t.m29326r()     // Catch:{ all -> 0x047d }
            android.app.Activity r4 = r1.f8767m     // Catch:{ all -> 0x047d }
            int[] r4 = p073j4.C4751b2.m30620o(r4)     // Catch:{ all -> 0x047d }
            r5 = 0
            r6 = r3[r5]     // Catch:{ all -> 0x047d }
            r7 = 1
            r3 = r3[r7]     // Catch:{ all -> 0x047d }
            int r8 = r1.f8764j     // Catch:{ all -> 0x047d }
            r9 = 5
            r10 = 4
            r11 = 3
            r13 = 2
            ...
            goto L_0x024f
        L_0x0122:
            int r15 = r1.f8761g     // Catch:{ all -> 0x047d }
        ...
        L_0x012a:
            ...
            com.google.android.gms.internal.ads.pm0.m18667g(r3)     // Catch:{ all -> 0x047d }
            goto L_0x0254
        L_0x0135:
            boolean r3 = r1.f8758d     // Catch:{ all -> 0x047d }
            if (r3 == 0) goto L_0x0208
            java.lang.String r3 = r1.f8757c     // Catch:{ all -> 0x047d }
        ...
        L_0x0180:
            ...
            int r3 = r1.f8759e     // Catch:{ all -> 0x047d }
            int r12 = r1.f8762h     // Catch:{ all -> 0x047d }
            int r3 = r3 + r12
            int r3 = r3 + r8
            int r3 = r3 + -50
            int r8 = r1.f8760f     // Catch:{ all -> 0x047d }
            goto L_0x01dc
        L_0x0197:
            int r3 = r1.f8759e     // Catch:{ all -> 0x047d }
            int r12 = r1.f8762h     // Catch:{ all -> 0x047d }
        ...
        L_0x01a2:
            ...
            int r8 = r1.f8760f     // Catch:{ all -> 0x047d }
        L_0x01ad:
            int r12 = r1.f8763i     // Catch:{ all -> 0x047d }
            goto L_0x01b8
        L_0x01b0:
            int r3 = r1.f8759e     // Catch:{ all -> 0x047d }
            int r8 = r1.f8762h     // Catch:{ all -> 0x047d }
            int r3 = r3 + r8
            int r8 = r1.f8760f     // Catch:{ all -> 0x047d }
            goto L_0x01ad
        L_0x01b8:
        ...
        L_0x01f7:
            ...
            int r3 = r1.f8759e     // Catch:{ all -> 0x047d }
            int r4 = r1.f8762h     // Catch:{ all -> 0x047d }
            int r3 = r3 + r4
            r15[r5] = r3     // Catch:{ all -> 0x047d }
            int r3 = r1.f8760f     // Catch:{ all -> 0x047d }
            int r4 = r1.f8763i     // Catch:{ all -> 0x047d }
            int r3 = r3 + r4
        ...
        L_0x0208:
            ...
            int r6 = r1.f8759e     // Catch:{ all -> 0x047d }
            int r8 = r1.f8762h     // Catch:{ all -> 0x047d }
            int r6 = r6 + r8
            int r8 = r1.f8760f     // Catch:{ all -> 0x047d }
            int r12 = r1.f8763i     // Catch:{ all -> 0x047d }
            ...
            goto L_0x0232
        L_0x022a:
            int r12 = r1.f8764j     // Catch:{ all -> 0x047d }
            int r15 = r6 + r12
        ...
        L_0x0232:
            ...
            goto L_0x0242
        L_0x0238:
            int r3 = r1.f8761g     // Catch:{ all -> 0x047d }
            int r12 = r8 + r3
        ...
        L_0x0255:
            ...
            return
        L_0x025e:
            p060h4.C4584t.m30036b()     // Catch:{ all -> 0x047d }
            android.app.Activity r3 = r1.f8767m     // Catch:{ all -> 0x047d }
            int r4 = r1.f8764j     // Catch:{ all -> 0x047d }
            int r3 = com.google.android.gms.internal.ads.im0.m14418y(r3, r4)     // Catch:{ all -> 0x047d }
            p060h4.C4584t.m30036b()     // Catch:{ all -> 0x047d }
            android.app.Activity r4 = r1.f8767m     // Catch:{ all -> 0x047d }
            int r6 = r1.f8761g     // Catch:{ all -> 0x047d }
            int r4 = com.google.android.gms.internal.ads.im0.m14418y(r4, r6)     // Catch:{ all -> 0x047d }
            com.google.android.gms.internal.ads.vs0 r6 = r1.f8766l     // Catch:{ all -> 0x047d }
            ...
            com.google.android.gms.internal.ads.vs0 r8 = r1.f8766l     // Catch:{ all -> 0x047d }
            android.view.View r8 = (android.view.View) r8     // Catch:{ all -> 0x047d }
            r6.removeView(r8)     // Catch:{ all -> 0x047d }
            android.widget.PopupWindow r8 = r1.f8772r     // Catch:{ all -> 0x047d }
            if (r8 != 0) goto L_0x02c8
            r1.f8774t = r6     // Catch:{ all -> 0x047d }
            p053g4.C4409t.m29326r()     // Catch:{ all -> 0x047d }
            com.google.android.gms.internal.ads.vs0 r6 = r1.f8766l     // Catch:{ all -> 0x047d }
            r8 = r6
            android.view.View r8 = (android.view.View) r8     // Catch:{ all -> 0x047d }
            ...
            android.app.Activity r12 = r1.f8767m     // Catch:{ all -> 0x047d }
            r6.<init>(r12)     // Catch:{ all -> 0x047d }
            r1.f8769o = r6     // Catch:{ all -> 0x047d }
            r6.setImageBitmap(r8)     // Catch:{ all -> 0x047d }
            com.google.android.gms.internal.ads.vs0 r6 = r1.f8766l     // Catch:{ all -> 0x047d }
            com.google.android.gms.internal.ads.mu0 r6 = r6.mo9698n()     // Catch:{ all -> 0x047d }
            r1.f8768n = r6     // Catch:{ all -> 0x047d }
            android.view.ViewGroup r6 = r1.f8774t     // Catch:{ all -> 0x047d }
            android.widget.ImageView r8 = r1.f8769o     // Catch:{ all -> 0x047d }
        ...
        L_0x02cb:
            ...
            android.app.Activity r8 = r1.f8767m     // Catch:{ all -> 0x047d }
            r6.<init>(r8)     // Catch:{ all -> 0x047d }
            r1.f8773s = r6     // Catch:{ all -> 0x047d }
            r6.setBackgroundColor(r5)     // Catch:{ all -> 0x047d }
            android.widget.RelativeLayout r6 = r1.f8773s     // Catch:{ all -> 0x047d }
            ...
            r1.f8772r = r8     // Catch:{ all -> 0x047d }
            r8.setOutsideTouchable(r5)     // Catch:{ all -> 0x047d }
            android.widget.PopupWindow r6 = r1.f8772r     // Catch:{ all -> 0x047d }
            r6.setTouchable(r7)     // Catch:{ all -> 0x047d }
            android.widget.PopupWindow r6 = r1.f8772r     // Catch:{ all -> 0x047d }
            boolean r8 = r1.f8758d     // Catch:{ all -> 0x047d }
            r8 = r8 ^ r7
            ...
            android.app.Activity r8 = r1.f8767m     // Catch:{ all -> 0x047d }
            r6.<init>(r8)     // Catch:{ all -> 0x047d }
            r1.f8770p = r6     // Catch:{ all -> 0x047d }
            android.widget.RelativeLayout$LayoutParams r6 = new android.widget.RelativeLayout$LayoutParams     // Catch:{ all -> 0x047d }
            p060h4.C4584t.m30036b()     // Catch:{ all -> 0x047d }
            android.app.Activity r8 = r1.f8767m     // Catch:{ all -> 0x047d }
            int r8 = com.google.android.gms.internal.ads.im0.m14418y(r8, r14)     // Catch:{ all -> 0x047d }
            p060h4.C4584t.m30036b()     // Catch:{ all -> 0x047d }
            android.app.Activity r12 = r1.f8767m     // Catch:{ all -> 0x047d }
            int r12 = com.google.android.gms.internal.ads.im0.m14418y(r12, r14)     // Catch:{ all -> 0x047d }
            r6.<init>(r8, r12)     // Catch:{ all -> 0x047d }
            java.lang.String r8 = r1.f8757c     // Catch:{ all -> 0x047d }
        ...
        L_0x03ad:
            ...
            r6.addRule(r8)     // Catch:{ all -> 0x047d }
        L_0x03b3:
            android.widget.LinearLayout r5 = r1.f8770p     // Catch:{ all -> 0x047d }
            com.google.android.gms.internal.ads.de0 r8 = new com.google.android.gms.internal.ads.de0     // Catch:{ all -> 0x047d }
            ...
            android.widget.RelativeLayout r5 = r1.f8773s     // Catch:{ all -> 0x047d }
            android.widget.LinearLayout r8 = r1.f8770p     // Catch:{ all -> 0x047d }
            r5.addView(r8, r6)     // Catch:{ all -> 0x047d }
            android.widget.PopupWindow r5 = r1.f8772r     // Catch:{ RuntimeException -> 0x0424 }
            android.view.View r0 = r0.getDecorView()     // Catch:{ RuntimeException -> 0x0424 }
            p060h4.C4584t.m30036b()     // Catch:{ RuntimeException -> 0x0424 }
            android.app.Activity r6 = r1.f8767m     // Catch:{ RuntimeException -> 0x0424 }
            r8 = 0
            r9 = r15[r8]     // Catch:{ RuntimeException -> 0x0424 }
            int r6 = com.google.android.gms.internal.ads.im0.m14418y(r6, r9)     // Catch:{ RuntimeException -> 0x0424 }
            p060h4.C4584t.m30036b()     // Catch:{ RuntimeException -> 0x0424 }
            android.app.Activity r8 = r1.f8767m     // Catch:{ RuntimeException -> 0x0424 }
            r9 = r15[r7]     // Catch:{ RuntimeException -> 0x0424 }
            int r8 = com.google.android.gms.internal.ads.im0.m14418y(r8, r9)     // Catch:{ RuntimeException -> 0x0424 }
            r9 = 0
            r5.showAtLocation(r0, r9, r6, r8)     // Catch:{ RuntimeException -> 0x0424 }
            r0 = r15[r9]     // Catch:{ all -> 0x047d }
            r5 = r15[r7]     // Catch:{ all -> 0x047d }
            com.google.android.gms.internal.ads.me0 r6 = r1.f8771q     // Catch:{ all -> 0x047d }
            if (r6 == 0) goto L_0x03fb
            int r8 = r1.f8764j     // Catch:{ all -> 0x047d }
            int r9 = r1.f8761g     // Catch:{ all -> 0x047d }
            r6.mo11506a(r0, r5, r8, r9)     // Catch:{ all -> 0x047d }
        L_0x03fb:
            com.google.android.gms.internal.ads.vs0 r0 = r1.f8766l     // Catch:{ all -> 0x047d }
            com.google.android.gms.internal.ads.mu0 r3 = com.google.android.gms.internal.ads.mu0.m16709b(r3, r4)     // Catch:{ all -> 0x047d }
            r0.mo12100Z0(r3)     // Catch:{ all -> 0x047d }
            r0 = 0
            ...
            int r0 = r0 - r4
            int r4 = r1.f8764j     // Catch:{ all -> 0x047d }
            int r5 = r1.f8761g     // Catch:{ all -> 0x047d }
            r1.mo11987f(r3, r0, r4, r5)     // Catch:{ all -> 0x047d }
            java.lang.String r0 = "resized"
            r1.mo11988g(r0)     // Catch:{ all -> 0x047d }
            monitor-exit(r2)     // Catch:{ all -> 0x047d }
            return
        L_0x0424:
            r0 = move-exception
            ...
            r1.mo11984c(r0)     // Catch:{ all -> 0x047d }
            android.widget.RelativeLayout r0 = r1.f8773s     // Catch:{ all -> 0x047d }
            com.google.android.gms.internal.ads.vs0 r3 = r1.f8766l     // Catch:{ all -> 0x047d }
            android.view.View r3 = (android.view.View) r3     // Catch:{ all -> 0x047d }
            r0.removeView(r3)     // Catch:{ all -> 0x047d }
            android.view.ViewGroup r0 = r1.f8774t     // Catch:{ all -> 0x047d }
            if (r0 == 0) goto L_0x045f
            android.widget.ImageView r3 = r1.f8769o     // Catch:{ all -> 0x047d }
            r0.removeView(r3)     // Catch:{ all -> 0x047d }
            android.view.ViewGroup r0 = r1.f8774t     // Catch:{ all -> 0x047d }
            com.google.android.gms.internal.ads.vs0 r3 = r1.f8766l     // Catch:{ all -> 0x047d }
            android.view.View r3 = (android.view.View) r3     // Catch:{ all -> 0x047d }
            ...
            com.google.android.gms.internal.ads.vs0 r0 = r1.f8766l     // Catch:{ all -> 0x047d }
            com.google.android.gms.internal.ads.mu0 r3 = r1.f8768n     // Catch:{ all -> 0x047d }
            r0.mo12100Z0(r3)     // Catch:{ all -> 0x047d }
        L_0x045f:
            monitor-exit(r2)     // Catch:{ all -> 0x047d }
            return
        ...
        L_0x047d:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.ee0.mo9891i(java.util.Map):void");
    }

    /* renamed from: j */
    public final void mo9892j(int i, int i2, boolean z) {
        synchronized (this.f8765k) {
            this.f8759e = i;
            this.f8760f = i2;
        }
    ...
    /* renamed from: k */
    public final void mo9893k(int i, int i2) {
        this.f8759e = i;
        this.f8760f = i2;
    }

    /* renamed from: l */
    public final boolean mo9894l() {
        boolean z;
        synchronized (this.f8765k) {
            z = this.f8772r != null;
        }
