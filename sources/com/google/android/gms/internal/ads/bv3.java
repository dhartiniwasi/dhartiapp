...
final class bv3 {
    ...
    /* renamed from: a */
    private static final int[] f7472a = {0, 3, 6, 9, 12, 16, 19, 22, 25, 28};

    /* renamed from: b */
    private static final int[] f7473b = {0, 2, 3, 5, 6, 0, 1, 3, 4, 6};

    /* renamed from: c */
    private static final int[] f7474c = {67108863, 33554431};

    /* renamed from: d */
    private static final int[] f7475d = {26, 25};

    /* renamed from: a */
    static void m10593a(long[] jArr, long[] jArr2, long[] jArr3) {
        long[] jArr4 = new long[19];
        m10594b(jArr4, jArr2, jArr3);
        m10595c(jArr4, jArr);
    }
    ...
    static void m10594b(long[] r18, long[] r19, long[] r20) {
        /*
            r0 = 0
            r1 = r19[r0]
            r3 = r20[r0]
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.bv3.m10594b(long[], long[], long[]):void");
    }

    /* renamed from: c */
    static void m10595c(long[] jArr, long[] jArr2) {
        m10597e(jArr);
        m10596d(jArr);
    ...
    /* renamed from: f */
    static void m10598f(long[] jArr, long[] jArr2, long j) {
        for (int i = 0; i < 10; i++) {
            jArr[i] = jArr2[i] * j;
        }
    }
    ...
    /* renamed from: g */
    static void m10599g(long[] jArr, long[] jArr2) {
        long j = jArr2[0];
        long j2 = jArr2[0];
        long j3 = jArr2[1];
        ...
        long j48 = jArr2[8];
        long j49 = jArr2[9];
        m10595c(new long[]{j * j, (j2 + j2) * jArr2[1], j4 + j4, j5 + j5, (j6 * j6) + (j7 * 4 * j8) + ((j9 + j9) * jArr2[4]), j10 + j10, j17 + j17, j18 + j18, (j19 * j19) + j25 + j25, j26 + j26, j33 + j33, j34 + j34, (j35 * j35) + j39 + j39, j40 + j40, j45 + j45, j46 + j46, (j47 * j47) + (jArr2[7] * 4 * jArr2[9]), (j48 + j48) * jArr2[9], (j49 + j49) * j49}, jArr);
    }

    /* renamed from: h */
    static void m10600h(long[] jArr, long[] jArr2, long[] jArr3) {
        for (int i = 0; i < 10; i++) {
    ...
    /* renamed from: i */
    static void m10601i(long[] jArr, long[] jArr2, long[] jArr3) {
        for (int i = 0; i < 10; i++) {
            jArr[i] = jArr2[i] + jArr3[i];
        }
    }
    ...
    static byte[] m10602j(long[] jArr) {
        ...
        for (int i12 = 1; i12 < 10; i12++) {
            int i13 = ~(((int) copyOf[i12]) ^ f7474c[i12 & 1]);
            int i14 = i13 & (i13 << 16);
            int i15 = i14 & (i14 << 8);
            int i16 = i15 & (i15 << 4);
            int i17 = i16 & (i16 << 2);
        ...
        for (int i20 = 0; i20 < 10; i20++) {
            copyOf[i20] = copyOf[i20] << f7473b[i20];
        }
    ...
    /* renamed from: k */
    static long[] m10603k(byte[] bArr) {
        long[] jArr = new long[10];
        for (int i = 0; i < 10; i++) {
            int i2 = f7472a[i];
            jArr[i] = ((((((long) (bArr[i2] & 255)) | (((long) (bArr[i2 + 1] & 255)) << 8)) | (((long) (bArr[i2 + 2] & 255)) << 16)) | (((long) (bArr[i2 + 3] & 255)) << 24)) >> f7473b[i]) & ((long) f7474c[i & 1]);
        }
        return jArr;
    }
}
