...
public final class ln4 implements xn4 {

    /* renamed from: b */
    private static final int[] f12855b = {5, 4, 12, 8, 3, 10, 9, 11, 6, 2, 0, 1, 7, 16, 15, 14};

    /* renamed from: c */
    private static final kn4 f12856c = new kn4(gn4.f10008a);

    /* renamed from: d */
    private static final kn4 f12857d = new kn4(in4.f10885a);

    /* renamed from: b */
    private static final void m16076b(int i, List list) {
        switch (i) {
            case 0:
                list.add(new C3094z5());
                return;
            case 1:
                list.add(new C2241c6());
                return;
            case 2:
                list.add(new C2352f6(0));
                return;
            case 3:
                list.add(new C3088z(0));
                return;
            case 4:
                qn4 a = f12856c.mo11735a(0);
                if (a != null) {
                    list.add(a);
                    return;
                } else {
                    list.add(new C2793r0(0));
                    return;
                }
            case 5:
                list.add(new C2904u0());
                return;
            case 6:
                list.add(new C2684o3(0));
                return;
            case 7:
                list.add(new C2981w3(0));
                return;
            case 8:
                list.add(new C2834s4(0, (e92) null));
                list.add(new C3019x4(0));
                return;
            case 9:
                list.add(new C2649n5());
                return;
            case 10:
                list.add(new C2540k7());
                return;
            case 11:
                list.add(new C2911u7(1, 0, 112800));
                return;
            case 12:
                list.add(new C2392g8());
                return;
            case 14:
                list.add(new C3089z0());
                return;
            case 15:
                qn4 a2 = f12857d.mo11735a(new Object[0]);
                if (a2 != null) {
                    list.add(a2);
                    return;
                }
    ...
    public final synchronized com.google.android.gms.internal.ads.qn4[] mo8679a(android.net.Uri r21, java.util.Map r22) {
        /*
            r20 = this;
            monitor-enter(r20)
        ...
        L_0x003c:
            ...
            goto L_0x01a1
        L_0x003f:
            java.lang.String r3 = com.google.android.gms.internal.ads.d90.m11366e(r3)     // Catch:{ all -> 0x033e }
        ...
        L_0x01a1:
            ...
            m16076b(r3, r0)     // Catch:{ all -> 0x033e }
        L_0x01a6:
        ...
        L_0x0318:
            ...
            m16076b(r9, r0)     // Catch:{ all -> 0x033e }
        L_0x031f:
            int[] r2 = f12855b     // Catch:{ all -> 0x033e }
            r4 = 0
        L_0x0322:
            ...
            m16076b(r5, r0)     // Catch:{ all -> 0x033e }
        L_0x032d:
            int r4 = r4 + 1
            goto L_0x0322
        L_0x0330:
            int r1 = r0.size()     // Catch:{ all -> 0x033e }
            com.google.android.gms.internal.ads.qn4[] r1 = new com.google.android.gms.internal.ads.qn4[r1]     // Catch:{ all -> 0x033e }
            java.lang.Object[] r0 = r0.toArray(r1)     // Catch:{ all -> 0x033e }
            com.google.android.gms.internal.ads.qn4[] r0 = (com.google.android.gms.internal.ads.qn4[]) r0     // Catch:{ all -> 0x033e }
            monitor-exit(r20)
            return r0
        L_0x033e:
            r0 = move-exception
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.ln4.mo8679a(android.net.Uri, java.util.Map):com.google.android.gms.internal.ads.qn4[]");
    }

    public final synchronized qn4[] zza() {
        return mo8679a(Uri.EMPTY, new HashMap());
    }
}
