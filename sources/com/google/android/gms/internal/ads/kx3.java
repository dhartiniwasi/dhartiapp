...
public enum kx3 {
    ...
    /* renamed from: r0 */
    private static final kx3[] f12383r0 = null;

    /* renamed from: a */
    private final gy3 f12393a;

    /* renamed from: b */
    private final int f12394b;

    /* renamed from: c */
    private final Class f12395c;

    static {
        int i;
        f12383r0 = new kx3[r1];
        for (kx3 kx3 : values()) {
            f12383r0[kx3.f12394b] = kx3;
        }
    }

    private kx3(int i, int i2, gy3 gy3) {
        this.f12394b = i;
        this.f12393a = gy3;
        gy3 gy32 = gy3.VOID;
        int i3 = i2 - 1;
        if (i3 == 1) {
            this.f12395c = gy3.mo10679a();
        } else if (i3 != 3) {
            this.f12395c = null;
        } else {
            this.f12395c = gy3.mo10679a();
