...
public final class gv3 implements zn3 {

    /* renamed from: a */
    private final ThreadLocal f10072a;
    ...
    public gv3(java.lang.String r6, java.security.Key r7) throws java.security.GeneralSecurityException {
        /*
            r5 = this;
            r5.<init>()
            com.google.android.gms.internal.ads.fv3 r0 = new com.google.android.gms.internal.ads.fv3
            r0.<init>(r5)
            r5.f10072a = r0
            r1 = 2
            boolean r2 = com.google.android.gms.internal.ads.tj3.m21050a(r1)
        ...
        L_0x0090:
            ...
            throw r6
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.gv3.<init>(java.lang.String, java.security.Key):void");
    }

    /* renamed from: a */
    public final byte[] mo10018a(byte[] bArr, int i) throws GeneralSecurityException {
        if (i <= this.f10075d) {
            ((Mac) this.f10072a.get()).update(bArr);
            return Arrays.copyOf(((Mac) this.f10072a.get()).doFinal(), i);
        }
