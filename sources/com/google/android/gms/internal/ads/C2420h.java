...
public final class C2420h {
    ...
    /* renamed from: a */
    public static final byte[] f10130a = {0, 0, 0, 1};

    /* renamed from: b */
    public static final float[] f10131b = {1.0f, 1.0f, 1.0909091f, 0.90909094f, 1.4545455f, 1.2121212f, 2.1818182f, 1.8181819f, 2.909091f, 2.4242425f, 1.6363636f, 1.3636364f, 1.939394f, 1.6161616f, 1.3333334f, 1.5f, 2.0f};

    /* renamed from: c */
    private static final Object f10132c = new Object();

    /* renamed from: d */
    private static int[] f10133d = new int[10];

    /* renamed from: a */
    public static int m13646a(byte[] bArr, int i, int i2, boolean[] zArr) {
        boolean z;
        int i3 = i2 - i;
        boolean z2 = false;
        v91.m22052f(i3 >= 0);
    ...
    /* renamed from: b */
    public static int m13647b(byte[] bArr, int i) {
        int i2;
        synchronized (f10132c) {
            int i3 = 0;
            int i4 = 0;
            while (i3 < i) {
                while (true) {
                ...
                if (i3 < i) {
                    ...
                    if (length <= i4) {
                        f10133d = Arrays.copyOf(iArr, length + length);
                    }
                    f10133d[i4] = i3;
                    i3 += 3;
                    i4++;
    ...
    /* renamed from: c */
    public static C2345f m13648c(byte[] bArr, int i, int i2) {
        C2495j jVar = new C2495j(bArr, 4, i2);
        int c = jVar.mo11268c();
        int c2 = jVar.mo11268c();
        jVar.mo11269d();
        return new C2345f(c, c2, jVar.mo11271f());
    }
    ...
    public static com.google.android.gms.internal.ads.C2383g m13649d(byte[] r23, int r24, int r25) {
        /*
            ...
            r0.<init>(r1, r2, r3)
            r1 = 8
            int r2 = r0.mo11266a(r1)
            int r5 = r0.mo11266a(r1)
            int r6 = r0.mo11266a(r1)
            int r7 = r0.mo11268c()
        ...
        L_0x0143:
            r9 = r4
            r10 = r5
            boolean r3 = r0.mo11271f()
            r4 = 1065353216(0x3f800000, float:1.0)
            if (r3 == 0) goto L_0x018e
            boolean r3 = r0.mo11271f()
            if (r3 == 0) goto L_0x018e
            r3 = 8
            int r3 = r0.mo11266a(r3)
            r5 = 255(0xff, float:3.57E-43)
            if (r3 != r5) goto L_0x016e
            int r3 = r0.mo11266a(r8)
            int r0 = r0.mo11266a(r8)
            if (r3 == 0) goto L_0x018e
        ...
        L_0x0178:
            ...
            com.google.android.gms.internal.ads.ot1.m18060e(r3, r0)
        L_0x018e:
        ...
        L_0x0190:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.C2420h.m13649d(byte[], int, int):com.google.android.gms.internal.ads.g");
    }

    /* renamed from: e */
    public static void m13650e(boolean[] zArr) {
        zArr[0] = false;
        zArr[1] = false;
        zArr[2] = false;
    }
