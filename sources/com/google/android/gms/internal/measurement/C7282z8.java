...
public enum C7282z8 {
    ...
    GROUP_LIST(49, 2, r20),
    MAP(50, 4, C7155r9.VOID);
    

    /* renamed from: r0 */
    private static final C7282z8[] f32274r0 = null;

    /* renamed from: a */
    private final C7155r9 f32284a;

    /* renamed from: b */
    private final int f32285b;

    /* renamed from: c */
    private final Class f32286c;

    static {
        int i;
        f32274r0 = new C7282z8[r1];
        for (C7282z8 z8Var : values()) {
            f32274r0[z8Var.f32285b] = z8Var;
        }
    }

    private C7282z8(int i, int i2, C7155r9 r9Var) {
        this.f32285b = i;
        this.f32284a = r9Var;
        C7155r9 r9Var2 = C7155r9.VOID;
        int i3 = i2 - 1;
        if (i3 == 1) {
            this.f32286c = r9Var.mo23818a();
        } else if (i3 != 3) {
            this.f32286c = null;
        } else {
            this.f32286c = r9Var.mo23818a();
