...
public final class C7425m {
    ...
    static void m41765a(com.google.android.gms.measurement.internal.C7352f3 r14, android.database.sqlite.SQLiteDatabase r15, java.lang.String r16, java.lang.String r17, java.lang.String r18, java.lang.String[] r19) throws android.database.sqlite.SQLiteException {
        /*
            r9 = r15
            r10 = r16
            r11 = r19
        ...
        L_0x002f:
            ...
            r1 = r13
        L_0x0031:
            com.google.android.gms.measurement.internal.d3 r2 = r14.mo24261w()     // Catch:{ all -> 0x00e0 }
            java.lang.String r3 = "Error querying for table"
            r2.mo24210c(r3, r10, r0)     // Catch:{ all -> 0x00e0 }
        ...
        L_0x00ba:
            ...
            com.google.android.gms.measurement.internal.d3 r1 = r14.mo24261w()     // Catch:{ SQLiteException -> 0x00d5 }
            ...
            r1.mo24210c(r2, r10, r0)     // Catch:{ SQLiteException -> 0x00d5 }
        L_0x00cf:
            return
        L_0x00d0:
            r0 = move-exception
        ...
        L_0x00d5:
            r0 = move-exception
            com.google.android.gms.measurement.internal.d3 r1 = r14.mo24256q()
        ...
        L_0x00e8:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.measurement.internal.C7425m.m41765a(com.google.android.gms.measurement.internal.f3, android.database.sqlite.SQLiteDatabase, java.lang.String, java.lang.String, java.lang.String, java.lang.String[]):void");
    }

    /* renamed from: b */
    static void m41766b(C7352f3 f3Var, SQLiteDatabase sQLiteDatabase) {
        if (f3Var != null) {
            File file = new File(sQLiteDatabase.getPath());
            if (!file.setReadable(false, false)) {
                f3Var.mo24261w().mo24208a("Failed to turn off database read permission");
            }
            if (!file.setWritable(false, false)) {
                f3Var.mo24261w().mo24208a("Failed to turn off database write permission");
            }
            if (!file.setReadable(true, true)) {
                f3Var.mo24261w().mo24208a("Failed to turn on database read permission for owner");
            }
            if (!file.setWritable(true, true)) {
                f3Var.mo24261w().mo24208a("Failed to turn on database write permission for owner");
                return;
            }
            return;
        }
