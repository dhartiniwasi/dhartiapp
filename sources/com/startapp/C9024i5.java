...
/* compiled from: Sta */
public class C9024i5 {

    /* renamed from: a */
    public static Map<String, Class> f36960a;

    static {
        HashMap hashMap = new HashMap();
        f36960a = hashMap;
        hashMap.put("int[]", Integer.class);
        f36960a.put("long[]", Long.class);
        f36960a.put("double[]", Double.class);
        f36960a.put("float[]", Float.class);
        f36960a.put("bool[]", Boolean.class);
        f36960a.put("char[]", Character.class);
        f36960a.put("byte[]", Byte.class);
        f36960a.put("void[]", Void.class);
        f36960a.put("short[]", Short.class);
    }
    ...
    public static <T> T m48685a(java.lang.Class<T> r19, org.json.JSONObject r20) throws com.startapp.common.parser.JSONStreamException {
        /*
            r0 = r19
            r1 = r20
            java.lang.String r2 = "Problem instantiating object class "
            java.lang.Class<com.startapp.qb> r3 = com.startapp.C9248qb.class
            java.lang.Class<com.startapp.ob> r4 = com.startapp.C9199ob.class
            java.lang.annotation.Annotation r4 = r0.getAnnotation(r4)     // Catch:{ Exception -> 0x028e }
            com.startapp.ob r4 = (com.startapp.C9199ob) r4     // Catch:{ Exception -> 0x028e }
        ...
        L_0x003b:
            ...
            return r0
        L_0x0046:
            java.lang.Class<com.startapp.ob> r5 = com.startapp.C9199ob.class
        ...
        L_0x0055:
            ...
            java.lang.Object r0 = m48685a(r0, (org.json.JSONObject) r1)     // Catch:{ ClassNotFoundException -> 0x0089, JSONException -> 0x0082 }
            return r0
        L_0x0082:
            r0 = move-exception
        ...
        L_0x00c4:
            ...
            goto L_0x0286
        L_0x00da:
            java.lang.String r11 = com.startapp.C9112l5.m48943a(r6)
            ...
            java.lang.Class<com.startapp.pb> r14 = com.startapp.C9226pb.class
            boolean r13 = r13.equals(r14)     // Catch:{ Exception -> 0x0286, all -> 0x027d }
            if (r13 == 0) goto L_0x011f
            com.startapp.pb r12 = (com.startapp.C9226pb) r12     // Catch:{ Exception -> 0x0286, all -> 0x027d }
        ...
        L_0x0128:
            ...
            java.lang.Class<com.startapp.ob> r9 = com.startapp.C9199ob.class
            ...
            com.startapp.ob r8 = (com.startapp.C9199ob) r8     // Catch:{ Exception -> 0x0286, all -> 0x027d }
            ...
            org.json.JSONObject r9 = r1.getJSONObject(r11)     // Catch:{ Exception -> 0x0286, all -> 0x027d }
            java.lang.Object r8 = m48685a(r8, (org.json.JSONObject) r9)     // Catch:{ Exception -> 0x0286, all -> 0x027d }
        ...
        L_0x0173:
            ...
            com.startapp.qb r8 = (com.startapp.C9248qb) r8     // Catch:{ Exception -> 0x0286, all -> 0x027d }
        ...
        L_0x01b1:
            ...
            java.util.Map r8 = m48690a(r14, r15, r8, r9, r10)     // Catch:{ Exception -> 0x0286, all -> 0x027d }
            r6.set(r2, r8)     // Catch:{ Exception -> 0x0286, all -> 0x027d }
            goto L_0x0286
        L_0x01ca:
            ...
            java.util.List r8 = m48689a((java.lang.Class) r15, (org.json.JSONArray) r8)     // Catch:{ Exception -> 0x0286, all -> 0x027d }
            r6.set(r2, r8)     // Catch:{ Exception -> 0x0286, all -> 0x027d }
            goto L_0x0286
        L_0x01df:
            ...
            org.json.JSONArray r8 = r1.getJSONArray(r11)     // Catch:{ Exception -> 0x0286, all -> 0x027d }
            java.util.Set r8 = m48691b(r15, r8)     // Catch:{ Exception -> 0x0286, all -> 0x027d }
            r6.set(r2, r8)     // Catch:{ Exception -> 0x0286, all -> 0x027d }
            goto L_0x0286
        L_0x01f4:
        ...
        L_0x0236:
            ...
            java.lang.Object r8 = r1.get(r11)     // Catch:{ Exception -> 0x0286, all -> 0x027d }
            java.lang.Class r9 = r6.getType()     // Catch:{ Exception -> 0x0286, all -> 0x027d }
            java.lang.Object r8 = m48688a(r1, r6, r8, r9)     // Catch:{ Exception -> 0x0286, all -> 0x027d }
            r6.set(r2, r8)     // Catch:{ Exception -> 0x0286, all -> 0x027d }
            goto L_0x0286
        L_0x0250:
            java.lang.Class r8 = r6.getType()     // Catch:{ Exception -> 0x0286, all -> 0x027d }
            ...
            java.lang.Object r8 = m48687a(r1, r13, r6)     // Catch:{ Exception -> 0x0286, all -> 0x027d }
            r6.set(r2, r8)     // Catch:{ Exception -> 0x0286, all -> 0x027d }
            goto L_0x0286
        L_0x0262:
            java.lang.Object r8 = r1.get(r11)     // Catch:{ Exception -> 0x0286, all -> 0x027d }
            java.lang.Class r9 = r6.getType()     // Catch:{ Exception -> 0x0286, all -> 0x027d }
            java.lang.Object r8 = m48686a((java.lang.Object) r8, (java.lang.Class<?>) r9)     // Catch:{ Exception -> 0x0286, all -> 0x027d }
            r9 = 0
        ...
        L_0x028e:
            ...
            throw r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.startapp.C9024i5.m48685a(java.lang.Class, org.json.JSONObject):java.lang.Object");
    }

    /* renamed from: b */
    public static <V> Set<V> m48691b(Class<V> cls, JSONArray jSONArray) throws JSONException, JSONStreamException {
        ...
        for (int i = 0; i < jSONArray.length(); i++) {
            ...
            if (optJSONObject == null) {
                ...
                hashSet.add(m48685a(cls, optJSONObject));
            }
        }
        return hashSet;
    }
    ...
    /* renamed from: a */
    public static <T> Object m48687a(JSONObject jSONObject, Class<T> cls, Field field) throws JSONStreamException, JSONException, IllegalAccessException, NoSuchMethodException, InstantiationException, InvocationTargetException, IllegalArgumentException, NoSuchFieldException {
        Object obj;
        Class<Character> cls2 = Character.class;
        if (cls != null) {
            JSONArray jSONArray = jSONObject.getJSONArray(C9112l5.m48943a(field));
            int length = jSONArray.length();
            Object newInstance = Array.newInstance(cls, length);
            for (int i = 0; i < length; i++) {
                Array.set(newInstance, i, m48685a(cls, jSONArray.getJSONObject(i)));
            }
            return (Object[]) newInstance;
        }
        JSONArray jSONArray2 = jSONObject.getJSONArray(C9112l5.m48943a(field));
        int length2 = jSONArray2.length();
        Class<?> type = field.getType();
        Class cls3 = (Class) ((HashMap) f36960a).get(type.getSimpleName());
    ...
    /* renamed from: a */
    public static <K, V> Map m48690a(Class cls, Class cls2, Class cls3, JSONObject jSONObject, Iterator it) throws JSONException, JSONStreamException {
        HashMap hashMap = new HashMap();
        while (it.hasNext()) {
            Object next = it.next();
            ...
            if (optJSONObject == null) {
                ...
                if (optJSONArray != null) {
                    hashMap.put(cast, m48691b(cls3, optJSONArray));
                } else if (cls2.isEnum()) {
                ...
                hashMap.put(cast, m48685a(cls2, optJSONObject));
            }
        }
        return hashMap;
    }
    ...
    /* renamed from: a */
    public static <V> List m48689a(Class cls, JSONArray jSONArray) throws JSONException, JSONStreamException {
        ...
        for (int i = 0; i < jSONArray.length(); i++) {
            ...
            if (optJSONObject == null) {
                ...
                arrayList.add(m48685a(cls, optJSONObject));
            }
        }
        return arrayList;
    }
    ...
    /* renamed from: a */
    public static Object m48686a(Object obj, Class<?> cls) {
    ...
    /* renamed from: a */
    public static Object m48688a(JSONObject jSONObject, Field field, Object obj, Class<?> cls) throws JSONException {
        if (obj.getClass().equals(cls)) {
            return obj;
        }
        if (obj.getClass().equals(String.class)) {
            if (cls.equals(Integer.TYPE)) {
                return Integer.valueOf(jSONObject.getInt(C9112l5.m48943a(field)));
            }
            return obj;
