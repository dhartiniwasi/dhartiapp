...
/* renamed from: com.startapp.sdk.ads.splash.g */
/* compiled from: Sta */
public class C9342g {

    /* renamed from: com.startapp.sdk.ads.splash.g$a */
    /* compiled from: Sta */
    public static /* synthetic */ class C9343a {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f38445a     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f38445a     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f38445a     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                int[] r0 = f38445a     // Catch:{ NoSuchFieldError -> 0x003e }
            ...
            L_0x003e:
                int[] r0 = f38445a     // Catch:{ NoSuchFieldError -> 0x0049 }
            ...
            L_0x0049:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.startapp.sdk.ads.splash.C9342g.C9343a.<clinit>():void");
        }
    }

    /* renamed from: a */
    public static View m49454a(Context context, SplashConfig splashConfig) {
        int i;
        int i2;
        int i3;
        int i4;
        ...
        Point point = new Point(C9124m0.m48952a(context2, 1, (float) 150), C9124m0.m48952a(context2, 1, (float) 28));
        if (splashConfig.getOrientation() == SplashConfig.Orientation.PORTRAIT) {
            i4 = C9124m0.m48952a(context2, 1, (float) 5);
            i3 = C9124m0.m48952a(context2, 1, (float) 8);
            i2 = C9124m0.m48952a(context2, 1, (float) 75);
            i = C9124m0.m48952a(context2, 1, (float) 130);
        } else {
            i4 = C9124m0.m48952a(context2, 1, (float) 5);
            i3 = C9124m0.m48952a(context2, 1, (float) 8);
            i2 = C9124m0.m48952a(context2, 1, (float) 40);
            i = C9124m0.m48952a(context2, 1, (float) 100);
        }
        ImageView imageView = new ImageView(context2);
        imageView.setImageDrawable(splashConfig.getLogo());
        imageView.setId(C8710R.styleable.AppCompatTheme_switchStyle);
        ...
        layoutParams3.addRule(3, C8710R.styleable.AppCompatTheme_switchStyle);
        layoutParams3.setMargins(0, 0, 0, i2);
        relativeLayout2.addView(textView, layoutParams3);
        try {
            WebView b = ComponentLocator.m50248a(context).mo31187w().mo29704b();
            b.setId(C8710R.styleable.AppCompatTheme_textAppearanceLargePopupMenu);
        ...
        textView2.setId(C8710R.styleable.AppCompatTheme_textAppearanceListItemSmall);
        textView2.setTextSize(1, 18.0f);
        textView2.setTextColor(Color.rgb(208, 210, 210));
        textView2.setGravity(17);
        RelativeLayout.LayoutParams layoutParams5 = new RelativeLayout.LayoutParams(-2, -2);
        layoutParams5.addRule(14);
        layoutParams5.addRule(3, C8710R.styleable.AppCompatTheme_textAppearanceLargePopupMenu);
