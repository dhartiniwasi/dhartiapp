...
public class RcdTargets implements Serializable {
    ...
    @Keep
    /* compiled from: Sta */
    public static class Parser implements C9248qb<RcdTargets> {
            ...
            if (jSONObject != null) {
                ...
                while (keys.hasNext()) {
                    ...
                    if (next.equals("~")) {
                        ...
                        parseRec(str, C9688ze.m50607a(str2, next), jSONObject.optJSONObject(next), sortedMap, sortedMap2);
                    } else if (next.length() > 0) {
                        add(str, C9688ze.m50607a(str2, next), jSONObject.optInt(next), sortedMap, sortedMap2);
                    }
                }
            }
        }
    ...
    /* renamed from: a */
    public Collection<String> mo31093a(int i) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!C9605vb.m50465a(this.nameToScopesIds, rcdTargets.nameToScopesIds) || !C9605vb.m50465a(this.scopeToNamesIds, rcdTargets.scopeToNamesIds)) {
            return false;
        }
        return true;
    }
    ...
    /* renamed from: a */
    public String mo31092a(Map<String, Integer> map) {
        Pair pair;
        TreeMap treeMap = new TreeMap();
