...
public class AppEventsMetadata implements Serializable {
    ...
    @C9226pb(type = HashMap.class)
    private Map<String, String> active;
    @C9226pb(type = HashMap.class)
    private Map<String, String> inactive;
    @C9226pb(type = HashMap.class)
    private Map<String, String> launch;
    @C9226pb(type = HashMap.class, value = PeriodicAppEventMetadata.class)
    private Map<String, PeriodicAppEventMetadata> periodic;

    /* renamed from: a */
    public Map<String, String> mo31235a() {
        return this.active;
    }

    /* renamed from: b */
    public Map<String, String> mo31236b() {
        return this.inactive;
    }

    /* renamed from: c */
    public Map<String, String> mo31237c() {
        return this.launch;
    }

    /* renamed from: d */
    public Map<String, PeriodicAppEventMetadata> mo31238d() {
