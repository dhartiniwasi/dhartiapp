...
public class RatingBar extends LinearLayout {
    ...
    /* renamed from: a */
    public static Map<String, String> f39161a = new HashMap<String, String>() {
        {
    ...
    /* renamed from: a */
    public final void mo31230a(String str) {
        try {
            int a = C9265rb.m49233a(getContext(), 2);
            int a2 = C9265rb.m49233a(getContext(), 5);
            ImageView imageView = new ImageView(getContext());
            Bitmap a3 = C8941f1.m48561a(getContext(), str);
            if (a3 == null) {
                a3 = C8993h1.m48653a((String) ((HashMap) f39161a).get(str));
            }
            imageView.setImageBitmap(Bitmap.createScaledBitmap(a3, C9265rb.m49233a(getContext(), 15), C9265rb.m49233a(getContext(), 15), true));
    ...
    public void setRating(float f) {
        removeAllViews();
        float round = ((float) Math.round(f * 2.0f)) / 2.0f;
        int floor = (int) Math.floor((double) round);
        int i = round - ((float) floor) == 0.5f ? 1 : 0;
        int i2 = (5 - floor) - i;
        for (int i3 = 0; i3 < floor; i3++) {
            mo31230a("filled_star.png");
        }
        if (i != 0) {
            mo31230a("half_star.png");
        }
        for (int i4 = 0; i4 < i2; i4++) {
            mo31230a("empty_star.png");
        }
    }
}
