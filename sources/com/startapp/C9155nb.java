...
/* compiled from: Sta */
public class C9155nb {

    /* renamed from: a */
    private static final String f37349a = "nb";

    /* renamed from: b */
    private static final boolean f37350b = false;

    /* renamed from: c */
    private static final String f37351c = "truststore.bin";

    /* renamed from: d */
    private static final String f37352d = "truststore.bin.sig";

    /* renamed from: e */
    private static final int f37353e = 10000;

    /* JADX WARNING: Removed duplicated region for block: B:46:? A[RETURN, SYNTHETIC] */
    /* renamed from: a */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static boolean m48996a(android.content.Context r9) {
        /*
            r0 = 0
            com.startapp.y4 r1 = com.startapp.C8821a5.m48254b()     // Catch:{ all -> 0x00d8 }
            java.lang.String r1 = r1.CONNECTIVITY_TEST_TRUSTSTORE_URL()     // Catch:{ all -> 0x00d8 }
            java.lang.String r2 = "[PROJECTID]"
            com.startapp.y4 r3 = com.startapp.C8821a5.m48254b()     // Catch:{ all -> 0x00d8 }
            ...
            com.startapp.b5 r0 = com.startapp.C8821a5.m48255c()     // Catch:{ all -> 0x00d6 }
            long r2 = r0.mo29136F()     // Catch:{ all -> 0x00d6 }
            java.lang.String r0 = m48994a((long) r2)     // Catch:{ all -> 0x00d6 }
            ...
            com.startapp.b5 r0 = com.startapp.C8821a5.m48255c()     // Catch:{ all -> 0x00d6 }
            long r2 = com.startapp.C9603va.m50435d()     // Catch:{ all -> 0x00d6 }
            r0.mo29177h((long) r2)     // Catch:{ all -> 0x00d6 }
            goto L_0x00e4
        L_0x005c:
            int r0 = r1.getResponseCode()     // Catch:{ all -> 0x00d6 }
            ...
            java.io.File r4 = m49001e(r9)     // Catch:{ all -> 0x00d1 }
            m48995a((java.io.InputStream) r0, (java.io.File) r4)     // Catch:{ all -> 0x00d1 }
            r0.close()     // Catch:{ all -> 0x00d6 }
            com.startapp.y4 r0 = com.startapp.C8821a5.m48254b()     // Catch:{ all -> 0x00d6 }
            ...
            java.io.File r5 = m49001e(r9)     // Catch:{ all -> 0x00d6 }
            java.lang.String r6 = "truststore.bin"
            r0.<init>(r5, r6)     // Catch:{ all -> 0x00d6 }
            java.io.File r5 = new java.io.File     // Catch:{ all -> 0x00d6 }
            java.io.File r6 = m49001e(r9)     // Catch:{ all -> 0x00d6 }
            java.lang.String r7 = "truststore.bin.sig"
            r5.<init>(r6, r7)     // Catch:{ all -> 0x00d6 }
            boolean r0 = m48997a((java.io.File) r0, (java.io.File) r5)     // Catch:{ all -> 0x00d6 }
            goto L_0x009d
        L_0x009c:
            r0 = 1
        L_0x009d:
            if (r0 == 0) goto L_0x00c9
            boolean r0 = m49002f(r9)     // Catch:{ all -> 0x00d6 }
            if (r0 == 0) goto L_0x00c1
            boolean r0 = m49003g(r9)     // Catch:{ all -> 0x00d6 }
            if (r0 == 0) goto L_0x00c1
            com.startapp.b5 r0 = com.startapp.C8821a5.m48255c()     // Catch:{ all -> 0x00d6 }
            long r5 = com.startapp.C9603va.m50435d()     // Catch:{ all -> 0x00d6 }
            r0.mo29177h((long) r5)     // Catch:{ all -> 0x00d6 }
            com.startapp.b5 r0 = com.startapp.C8821a5.m48255c()     // Catch:{ all -> 0x00d6 }
            r0.mo29188l((long) r2)     // Catch:{ all -> 0x00d6 }
            r1.disconnect()
            return r4
        L_0x00c1:
        ...
        L_0x00d8:
            ...
            r0 = r8
        L_0x00dc:
            com.startapp.C9632x2.m50510a((java.lang.Throwable) r0)     // Catch:{ all -> 0x00e9 }
            m48998b(r9)     // Catch:{ all -> 0x00e9 }
        ...
        L_0x00ef:
            throw r9
        */
        throw new UnsupportedOperationException("Method not decompiled: com.startapp.C9155nb.m48996a(android.content.Context):boolean");
    }

    /* renamed from: b */
    private static void m48998b(Context context) {
        File file = new File(m49001e(context), f37351c);
        if (file.exists()) {
            file.delete();
        }
        File file2 = new File(m49001e(context), f37352d);
        if (file2.exists()) {
            file2.delete();
        }
    }
    ...
    /* renamed from: c */
    public static File m48999c(Context context) {
        File file = new File(context.getFilesDir() + "/insight/truststore/");
        if (!file.exists()) {
            file.mkdirs();
        }
        return new File(file, f37351c);
    }

    /* renamed from: d */
    public static File m49000d(Context context) {
        File file = new File(context.getFilesDir() + "/insight/truststore/");
        if (!file.exists()) {
            file.mkdirs();
        }
        return new File(file, f37352d);
    }

    /* renamed from: e */
    private static File m49001e(Context context) {
    ...
    /* renamed from: f */
    private static boolean m49002f(Context context) throws IOException {
        return new File(m49001e(context), f37351c).renameTo(m48999c(context));
    }

    /* renamed from: g */
    private static boolean m49003g(Context context) throws IOException {
        return new File(m49001e(context), f37352d).renameTo(m49000d(context));
    }

    /* renamed from: a */
    private static void m48995a(InputStream inputStream, File file) throws IOException {
    ...
    /* renamed from: a */
    private static String m48994a(long j) {
    ...
    /* renamed from: a */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static boolean m48997a(java.io.File r6, java.io.File r7) {
        /*
            r0 = 0
            r1 = 0
        ...
        L_0x003e:
            ...
            java.security.PublicKey r3 = com.startapp.C8821a5.m48257e()     // Catch:{ all -> 0x006a }
        ...
        L_0x005d:
            r7 = move-exception
            com.startapp.C9632x2.m50512b(r7)
        L_0x0061:
        ...
        L_0x0070:
            ...
            r4 = r0
        L_0x0072:
            com.startapp.C9632x2.m50510a((java.lang.Throwable) r6)     // Catch:{ all -> 0x008a }
            if (r0 == 0) goto L_0x007f
            r0.close()     // Catch:{ all -> 0x007b }
            goto L_0x007f
        L_0x007b:
            r6 = move-exception
            com.startapp.C9632x2.m50512b(r6)
        L_0x007f:
        ...
        L_0x009f:
            throw r6
        */
        throw new UnsupportedOperationException("Method not decompiled: com.startapp.C9155nb.m48997a(java.io.File, java.io.File):boolean");
    }
}
