...
public class LteFrequencyUtil {
    ...
    /* renamed from: h */
    private static final List<LteFrequencyUtil> f37961h = new ArrayList<LteFrequencyUtil>() {
        {
            ...
            add(new LteFrequencyUtil(67, 738.0f, 67336.0f, 67535.0f, 0.0f, 0.0f, 0.0f));
            add(new LteFrequencyUtil(68, 753.0f, 67536.0f, 67835.0f, 698.0f, 132672.0f, 132971.0f));
            add(new LteFrequencyUtil(69, 2570.0f, 67836.0f, 68335.0f, 0.0f, 0.0f, 0.0f));
    ...
    /* renamed from: a */
    private float f37962a;

    /* renamed from: b */
    private float f37963b;

    /* renamed from: c */
    private float f37964c;

    /* renamed from: d */
    private float f37965d;

    /* renamed from: e */
    private float f37966e;

    /* renamed from: f */
    private float f37967f;

    /* renamed from: g */
    private C8927e6 f37968g;

    /* renamed from: a */
    public static C8927e6 m49071a(int i) {
        C8927e6 e6Var = null;
        for (LteFrequencyUtil next : f37961h) {
            if (next.m49073b(i)) {
                e6Var = next.m49074c(i).f37968g;
            } else if (i > 0 && next.m49072a((long) i)) {
                e6Var = next.m49075d(i).f37968g;
            }
        }
        return e6Var;
    }
    ...
    /* renamed from: b */
    private boolean m49073b(int i) {
        float f = (float) i;
        return f >= this.f37967f && f <= this.f37966e;
    }

    /* renamed from: c */
    private LteFrequencyUtil m49074c(int i) {
        C8927e6 e6Var = this.f37968g;
        float f = (float) i;
        float f2 = ((f - this.f37967f) * 0.1f) + this.f37965d;
        e6Var.download_frequency = f2;
        e6Var.download_frequency = m49070a(f2, 1);
        C8927e6 e6Var2 = this.f37968g;
        e6Var2.download_earfcn = i;
        float f3 = this.f37962a;
        if (!(f3 == 0.0f && this.f37964c == 0.0f)) {
            float f4 = (e6Var2.download_frequency - this.f37965d) + f3;
            e6Var2.upload_frequency = f4;
            e6Var2.upload_frequency = m49070a(f4, 1);
            this.f37968g.upload_earfcn = (int) ((f - this.f37967f) + this.f37964c);
        }
        return this;
    }

    /* renamed from: d */
    private LteFrequencyUtil m49075d(int i) {
        C8927e6 e6Var = this.f37968g;
        float f = (float) i;
        float f2 = ((f - this.f37964c) * 0.1f) + this.f37962a;
        e6Var.upload_frequency = f2;
        e6Var.upload_frequency = m49070a(f2, 1);
        C8927e6 e6Var2 = this.f37968g;
        e6Var2.upload_earfcn = i;
        float f3 = (e6Var2.upload_frequency - this.f37962a) + this.f37965d;
        e6Var2.download_frequency = f3;
        e6Var2.download_frequency = m49070a(f3, 1);
        this.f37968g.download_earfcn = (int) ((f - this.f37964c) + this.f37967f);
        return this;
    }

    private LteFrequencyUtil(int i, float f, float f2, float f3, float f4, float f5, float f6) {
        this.f37968g = null;
        C8927e6 e6Var = new C8927e6();
        this.f37968g = e6Var;
        e6Var.band = i;
        this.f37962a = f4;
        this.f37963b = f6;
    ...
    /* renamed from: a */
    private boolean m49072a(long j) {
        float f = (float) j;
        return f >= this.f37964c && f <= this.f37963b;
    }

    /* renamed from: a */
    private float m49070a(float f, int i) {
        if (i >= 0) {
            float pow = (float) ((long) Math.pow(10.0d, (double) i));
            return ((float) ((long) Math.round(f * pow))) / pow;
        }
