...
/* compiled from: Sta */
public class C9197o9 {

    /* renamed from: a */
    public HashMap<Integer, SensorEvent> f38007a = new HashMap<>();

    /* renamed from: a */
    public JSONArray mo29794a() throws JSONException {
        JSONArray jSONArray = new JSONArray();
        for (SensorEvent next : this.f38007a.values()) {
