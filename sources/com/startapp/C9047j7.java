...
/* renamed from: com.startapp.j7 */
/* compiled from: Sta */
public class C9047j7 extends C9126m2 {

    /* renamed from: c */
    public static final String[] f37022c = {"id"};

    public C9047j7(Context context, String str) {
        super(context, str, (SQLiteDatabase.CursorFactory) null, 1);
    }

    /* renamed from: a */
    public void mo29519a(String str, String str2, long j, long j2) {
        String str3 = str;
        String str4 = str2;
        ...
        try {
            ...
            long a2 = m48713a(a, "requests", str);
            if (a2 < 0) {
                contentValues.clear();
                contentValues.put("value", str);
                a2 = a.insert("requests", (String) null, contentValues);
            }
            long a3 = m48713a(a, "statuses", str4);
            if (a3 < 0) {
                contentValues.clear();
    ...
    /* renamed from: a */
    public static long m48713a(SQLiteDatabase sQLiteDatabase, String str, String str2) {
        Cursor query = sQLiteDatabase.query(str, f37022c, "value=?", new String[]{str2}, (String) null, (String) null, (String) null);
        if (query != null) {
            try {
