...
/* compiled from: Sta */
public class C8993h1 {

    /* renamed from: com.startapp.h1$a */
    /* compiled from: Sta */
    public static class C8994a extends FilterInputStream {
        public C8994a(InputStream inputStream) {
            super(inputStream);
        }
    ...
    /* renamed from: a */
    public static Bitmap m48653a(String str) {
        if (str == null) {
            return null;
        }
        try {
    ...
    public static android.graphics.Bitmap m48655b(java.lang.String r5) {
        /*
            r0 = 0
            ...
            com.startapp.h1$a r3 = new com.startapp.h1$a     // Catch:{ all -> 0x002b }
        ...
        L_0x0036:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.startapp.C8993h1.m48655b(java.lang.String):android.graphics.Bitmap");
    }

    /* renamed from: a */
    public static Drawable m48654a(Resources resources, String str) {
        return new BitmapDrawable(resources, m48653a(str));
    }
}
