...
public final class C10486l {

    /* renamed from: a */
    private static final String f41526a;

    /* renamed from: b */
    private static final boolean f41527b;

    static {
        String name = Charset.defaultCharset().name();
        f41526a = name;
        f41527b = "SJIS".equalsIgnoreCase(name) || "EUC_JP".equalsIgnoreCase(name);
    }

    /* renamed from: a */
    public static String m52858a(byte[] bArr, Map<C9913e, ?> map) {
        byte[] bArr2 = bArr;
        Map<C9913e, ?> map2 = map;
        if (map2 != null) {
            C9913e eVar = C9913e.CHARACTER_SET;
        ...
        while (i3 < length && (z || z3 || z4)) {
            ...
            if (z4) {
                if (i4 > 0) {
                    if ((b & C8843b4.f36445d) != 0) {
                        i4--;
                    }
                } else if ((b & C8843b4.f36445d) != 0) {
                    if ((b & 64) != 0) {
                        i4++;
                        if ((b & 32) == 0) {
                            i6++;
