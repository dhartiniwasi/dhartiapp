...
public final class SidecarWindowBackend implements WindowBackend {
    ...
    public final class ExtensionListenerImpl implements ExtensionInterfaceCompat.ExtensionCallbackInterface {
        ...
        public ExtensionListenerImpl(SidecarWindowBackend sidecarWindowBackend) {
            C11669k.m56787e(sidecarWindowBackend, "this$0");
        ...
        public void onWindowLayoutChanged(Activity activity, WindowLayoutInfo windowLayoutInfo) {
            ...
            while (it.hasNext()) {
                ...
                if (C11669k.m56783a(next.getActivity(), activity)) {
    ...
    public static final class WindowLayoutChangeCallbackWrapper {
        ...
        private final C0823a<WindowLayoutInfo> callback;
        private final Executor executor;
        private WindowLayoutInfo lastInfo;

        public WindowLayoutChangeCallbackWrapper(Activity activity2, Executor executor2, C0823a<WindowLayoutInfo> aVar) {
        ...
        public static final void m62927accept$lambda0(WindowLayoutChangeCallbackWrapper windowLayoutChangeCallbackWrapper, WindowLayoutInfo windowLayoutInfo) {
            C11669k.m56787e(windowLayoutChangeCallbackWrapper, "this$0");
            C11669k.m56787e(windowLayoutInfo, "$newLayoutInfo");
        ...
        public final void accept(WindowLayoutInfo windowLayoutInfo) {
            ...
            this.executor.execute(new C1521a(this, windowLayoutInfo));
        }
        ...
        public final C0823a<WindowLayoutInfo> getCallback() {
    ...
    private final void callbackRemovedForActivity(Activity activity) {
        ...
        if (!(copyOnWriteArrayList instanceof Collection) || !copyOnWriteArrayList.isEmpty()) {
            ...
            while (true) {
                if (it.hasNext()) {
                    if (C11669k.m56783a(((WindowLayoutChangeCallbackWrapper) it.next()).getActivity(), activity)) {
                        z = true;
                        break;
                    }
                } else {
    ...
    private final boolean isActivityRegistered(Activity activity) {
        ...
        for (WindowLayoutChangeCallbackWrapper activity2 : copyOnWriteArrayList) {
            if (C11669k.m56783a(activity2.getActivity(), activity)) {
                return true;
            }
        }
        return false;
    ...
    public void registerLayoutChangeCallback(Activity activity, Executor executor, C0823a<WindowLayoutInfo> aVar) {
        ...
        try {
            ...
            if (windowExtension2 == null) {
                aVar.accept(new WindowLayoutInfo(C10522j.m52968d()));
                return;
            }
            ...
            if (!isActivityRegistered) {
                ...
                while (true) {
                    ...
                    t = it.next();
                    if (C11669k.m56783a(activity, ((WindowLayoutChangeCallbackWrapper) t).getActivity())) {
                        break;
                    }
                }
            ...
            if (getWindowExtension() != null) {
                ...
                while (it.hasNext()) {
                    ...
                    if (next.getCallback() == aVar) {
                        C11669k.m56786d(next, "callbackWrapper");
                        arrayList.add(next);
                    }
                }
