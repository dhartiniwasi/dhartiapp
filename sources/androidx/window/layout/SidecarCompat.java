...
public final class SidecarCompat implements ExtensionInterfaceCompat {
    ...
    private static final class DistinctElementCallback implements ExtensionInterfaceCompat.ExtensionCallbackInterface {
        ...
        public DistinctElementCallback(ExtensionInterfaceCompat.ExtensionCallbackInterface extensionCallbackInterface) {
            C11669k.m56787e(extensionCallbackInterface, "callbackInterface");
        ...
        public void onWindowLayoutChanged(Activity activity, WindowLayoutInfo windowLayoutInfo) {
            ...
            C11669k.m56787e(windowLayoutInfo, "newLayout");
            ReentrantLock reentrantLock = this.lock;
            reentrantLock.lock();
            try {
                if (!C11669k.m56783a(windowLayoutInfo, this.activityWindowLayoutInfo.get(activity))) {
    ...
    private static final class DistinctSidecarElementCallback implements SidecarInterface.SidecarCallback {
        ...
        public DistinctSidecarElementCallback(SidecarAdapter sidecarAdapter2, SidecarInterface.SidecarCallback sidecarCallback) {
            C11669k.m56787e(sidecarAdapter2, "sidecarAdapter");
            C11669k.m56787e(sidecarCallback, "callbackInterface");
            this.sidecarAdapter = sidecarAdapter2;
            this.callbackInterface = sidecarCallback;
        }

        public void onDeviceStateChanged(SidecarDeviceState sidecarDeviceState) {
            C11669k.m56787e(sidecarDeviceState, "newDeviceState");
            ReentrantLock reentrantLock = this.lock;
            reentrantLock.lock();
            try {
        ...
        public void onWindowLayoutChanged(IBinder iBinder, SidecarWindowLayoutInfo sidecarWindowLayoutInfo) {
            C11669k.m56787e(iBinder, "token");
            C11669k.m56787e(sidecarWindowLayoutInfo, "newLayout");
    ...
    private static final class FirstAttachAdapter implements View.OnAttachStateChangeListener {
        ...
        public FirstAttachAdapter(SidecarCompat sidecarCompat2, Activity activity) {
            C11669k.m56787e(sidecarCompat2, "sidecarCompat");
            C11669k.m56787e(activity, "activity");
    ...
    public final class TranslatingCallback implements SidecarInterface.SidecarCallback {
        ...
        public TranslatingCallback(SidecarCompat sidecarCompat) {
            C11669k.m56787e(sidecarCompat, "this$0");
        ...
        public void onWindowLayoutChanged(IBinder iBinder, SidecarWindowLayoutInfo sidecarWindowLayoutInfo) {
            C11669k.m56787e(iBinder, "windowToken");
            C11669k.m56787e(sidecarWindowLayoutInfo, "newLayout");
    ...
    private final void registerConfigurationChangeListener(Activity activity) {
        if (this.componentCallbackMap.get(activity) == null) {
            C1520xe5f1d4c7 sidecarCompat$registerConfigurationChangeListener$configChangeObserver$1 = new C1520xe5f1d4c7(this, activity);
    ...
    public void setExtensionCallback(ExtensionInterfaceCompat.ExtensionCallbackInterface extensionCallbackInterface) {
        C11669k.m56787e(extensionCallbackInterface, "extensionCallback");
    ...
    public boolean validateExtensionInterface() {
        ...
        L_0x0024:
            ...
            boolean r4 = kotlin.jvm.internal.C11669k.m56783a(r2, r4)     // Catch:{ all -> 0x019a }
        ...
        L_0x00ae:
            ...
            boolean r2 = kotlin.jvm.internal.C11669k.m56783a(r3, r2)     // Catch:{ all -> 0x019a }
        ...
        L_0x00f2:
            ...
            kotlin.jvm.internal.C11669k.m56786d(r3, r4)     // Catch:{ all -> 0x019a }
        ...
        L_0x0112:
            ...
            boolean r2 = kotlin.jvm.internal.C11669k.m56783a(r4, r2)     // Catch:{ all -> 0x019a }
        ...
        L_0x016a:
            ...
            java.lang.String r2 = kotlin.jvm.internal.C11669k.m56792j(r2, r3)     // Catch:{ all -> 0x019a }
            r0.<init>(r2)     // Catch:{ all -> 0x019a }
            throw r0     // Catch:{ all -> 0x019a }
        L_0x0176:
            java.lang.NoSuchMethodException r0 = new java.lang.NoSuchMethodException     // Catch:{ all -> 0x019a }
            java.lang.String r3 = "Illegal return type for 'onWindowLayoutChangeListenerAdded': "
            java.lang.String r2 = kotlin.jvm.internal.C11669k.m56792j(r3, r2)     // Catch:{ all -> 0x019a }
            r0.<init>(r2)     // Catch:{ all -> 0x019a }
            throw r0     // Catch:{ all -> 0x019a }
        L_0x0182:
            java.lang.NoSuchMethodException r0 = new java.lang.NoSuchMethodException     // Catch:{ all -> 0x019a }
