...
public class C0563v extends RadioButton implements C0997m, C0957y, C0998n {

    /* renamed from: a */
    private final C0502j f1851a;

    /* renamed from: b */
    private final C0481e f1852b;

    /* renamed from: c */
    private final C0466c0 f1853c;

    /* renamed from: d */
    private C0521n f1854d;

    public C0563v(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C4288a.f23753F);
    }

    private C0521n getEmojiTextViewHelper() {
        if (this.f1854d == null) {
            this.f1854d = new C0521n(this);
        }
        return this.f1854d;
    }
    ...
    public void drawableStateChanged() {
        ...
        C0481e eVar = this.f1852b;
        if (eVar != null) {
            eVar.mo2211b();
        }
        C0466c0 c0Var = this.f1853c;
        if (c0Var != null) {
            c0Var.mo2087b();
        }
    }
    ...
    public ColorStateList getSupportCompoundDrawablesTintList() {
        return this.f1853c.mo2094j();
    }

    public PorterDuff.Mode getSupportCompoundDrawablesTintMode() {
        return this.f1853c.mo2095k();
    }
    ...
    public void setSupportCompoundDrawablesTintList(ColorStateList colorStateList) {
        this.f1853c.mo2107w(colorStateList);
        this.f1853c.mo2087b();
    }

    public void setSupportCompoundDrawablesTintMode(PorterDuff.Mode mode) {
        this.f1853c.mo2108x(mode);
        this.f1853c.mo2087b();
    }

    public C0563v(Context context, AttributeSet attributeSet, int i) {
