...
public class AlertDialogLayout extends C0519m0 {
    public AlertDialogLayout(Context context, AttributeSet attributeSet) {
        super(context, attributeSet);
    }

    /* renamed from: A */
    private void m2034A(View view, int i, int i2, int i3, int i4) {
        view.layout(i, i2, i3 + i, i4 + i2);
    }

    /* renamed from: B */
    private static int m2035B(View view) {
        int C = C0835a0.m3684C(view);
        if (C > 0) {
            return C;
        }
        if (view instanceof ViewGroup) {
            ...
            if (viewGroup.getChildCount() == 1) {
                return m2035B(viewGroup.getChildAt(0));
            }
        }
        return 0;
    }
    ...
    /* renamed from: C */
    private boolean m2036C(int i, int i2) {
        int i3;
        int i4;
        int i5;
        int i6;
        ...
        for (int i10 = 0; i10 < childCount; i10++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (id == C4293f.f23871P) {
                    view = childAt;
                } else if (id == C4293f.f23882k) {
                    view2 = childAt;
                } else if ((id != C4293f.f23884m && id != C4293f.f23886o) || view3 != null) {
                    return false;
                } else {
                    view3 = childAt;
                }
        ...
        m2037l(childCount, i9);
        return true;
    }

    /* renamed from: l */
    private void m2037l(int i, int i2) {
        int makeMeasureSpec = View.MeasureSpec.makeMeasureSpec(getMeasuredWidth(), 1073741824);
        for (int i3 = 0; i3 < i; i3++) {
            View childAt = getChildAt(i3);
            if (childAt.getVisibility() != 8) {
                C0519m0.C0520a aVar = (C0519m0.C0520a) childAt.getLayoutParams();
                if (aVar.width == -1) {
                    int i4 = aVar.height;
    ...
    public void onLayout(boolean r18, int r19, int r20, int r21, int r22) {
        ...
        L_0x005a:
            ...
            r15 = r2
            androidx.appcompat.widget.m0$a r15 = (androidx.appcompat.widget.C0519m0.C0520a) r15
            int r2 = r15.gravity
            if (r2 >= 0) goto L_0x007e
            r2 = r11
        L_0x007e:
            int r3 = androidx.core.view.C0835a0.m3682B(r17)
            int r2 = androidx.core.view.C0901e.m4084b(r2, r3)
            r2 = r2 & 7
            r3 = 1
