...
public class C0477d extends AutoCompleteTextView implements C0957y, C0998n {

    /* renamed from: d */
    private static final int[] f1578d = {16843126};

    /* renamed from: a */
    private final C0481e f1579a;

    /* renamed from: b */
    private final C0466c0 f1580b;

    /* renamed from: c */
    private final C0518m f1581c;

    public C0477d(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C4288a.f23776p);
    }

    /* access modifiers changed from: package-private */
    /* renamed from: a */
    public void mo2153a(C0518m mVar) {
    ...
    public void drawableStateChanged() {
        ...
        C0481e eVar = this.f1579a;
        if (eVar != null) {
            eVar.mo2211b();
        }
        C0466c0 c0Var = this.f1580b;
        if (c0Var != null) {
            c0Var.mo2087b();
        }
    }
    ...
    public ColorStateList getSupportCompoundDrawablesTintList() {
        return this.f1580b.mo2094j();
    }

    public PorterDuff.Mode getSupportCompoundDrawablesTintMode() {
        return this.f1580b.mo2095k();
    }

    public InputConnection onCreateInputConnection(EditorInfo editorInfo) {
        return this.f1581c.mo2438d(C0532o.m2599a(super.onCreateInputConnection(editorInfo), editorInfo, this), editorInfo);
    }
    ...
    public void setEmojiCompatEnabled(boolean z) {
        this.f1581c.mo2439e(z);
    }

    public void setKeyListener(KeyListener keyListener) {
        super.setKeyListener(this.f1581c.mo2435a(keyListener));
    }
    ...
    public void setSupportCompoundDrawablesTintList(ColorStateList colorStateList) {
        this.f1580b.mo2107w(colorStateList);
        this.f1580b.mo2087b();
    }

    public void setSupportCompoundDrawablesTintMode(PorterDuff.Mode mode) {
        this.f1580b.mo2108x(mode);
        this.f1580b.mo2087b();
    }
    ...
    public C0477d(Context context, AttributeSet attributeSet, int i) {
        super(C0569x0.m2725b(context), attributeSet, i);
        C0564v0.m2713a(this, getContext());
        C0452a1 v = C0452a1.m2210v(getContext(), attributeSet, f1578d, i, 0);
        if (v.mo2060s(0)) {
