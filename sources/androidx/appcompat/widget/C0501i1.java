...
public class C0501i1 extends C0550r0 {

    /* renamed from: c */
    private static boolean f1652c = false;

    /* renamed from: b */
    private final WeakReference<Context> f1653b;

    public C0501i1(Context context, Resources resources) {
        super(resources);
        this.f1653b = new WeakReference<>(context);
    }

    /* renamed from: b */
    public static boolean m2468b() {
        return f1652c;
    }

    /* renamed from: c */
    public static boolean m2469c() {
        return m2468b() && Build.VERSION.SDK_INT <= 20;
    }
    ...
    public Drawable getDrawable(int i) throws Resources.NotFoundException {
        Context context = (Context) this.f1653b.get();
        if (context != null) {
            return C0541q0.m2634h().mo2553t(context, this, i);
        }
        return mo2568a(i);
    }
