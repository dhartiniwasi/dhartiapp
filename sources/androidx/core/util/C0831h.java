...
public final class C0831h {
    /* renamed from: a */
    public static void m3657a(boolean z, Object obj) {
        if (!z) {
    ...
    /* renamed from: b */
    public static int m3658b(int i, int i2, int i3, String str) {
        if (i < i2) {
    ...
    /* renamed from: c */
    public static int m3659c(int i) {
        if (i >= 0) {
            return i;
        }
    ...
    /* renamed from: d */
    public static int m3660d(int i, String str) {
        if (i >= 0) {
            return i;
        }
    ...
    /* renamed from: e */
    public static int m3661e(int i, int i2) {
        if ((i & i2) == i) {
            return i;
        }
    ...
    /* renamed from: f */
    public static <T> T m3662f(T t) {
        Objects.requireNonNull(t);
        return t;
    }

    /* renamed from: g */
    public static <T> T m3663g(T t, Object obj) {
        if (t != null) {
            return t;
        }
    ...
    /* renamed from: h */
    public static void m3664h(boolean z, String str) {
        if (!z) {
