...
public class C1489c {
    /* renamed from: a */
    private static Interpolator m6891a(Context context, Resources resources, Resources.Theme theme, XmlPullParser xmlPullParser) throws XmlPullParserException, IOException {
        Interpolator fVar;
                ...
                if (next == 2) {
                    ...
                    if (name.equals("linearInterpolator")) {
                        ...
                        if (name.equals("accelerateInterpolator")) {
                            ...
                            fVar = new C1493f(context, asAttributeSet, xmlPullParser);
                        } else {
    ...
    /* renamed from: b */
    public static Interpolator m6892b(Context context, int i) throws Resources.NotFoundException {
        ...
        if (i == 17563663) {
            ...
            Interpolator a = m6891a(context, context.getResources(), context.getTheme(), animation);
            if (animation != null) {
                animation.close();
            }
            return a;
