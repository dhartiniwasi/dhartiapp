...
public final class C5844s implements C5798f, C5840p0 {

    /* renamed from: p */
    public static final C6685q<Long> f28918p = C6685q.m38438A(4800000L, 3100000L, 2100000L, 1500000L, 800000L);

    /* renamed from: q */
    public static final C6685q<Long> f28919q = C6685q.m38438A(1500000L, 1000000L, 730000L, 440000L, 170000L);

    /* renamed from: r */
    public static final C6685q<Long> f28920r = C6685q.m38438A(2200000L, 1400000L, 1100000L, 910000L, 620000L);

    /* renamed from: s */
    public static final C6685q<Long> f28921s = C6685q.m38438A(3000000L, 1900000L, 1400000L, 1000000L, 660000L);

    /* renamed from: t */
    public static final C6685q<Long> f28922t = C6685q.m38438A(6000000L, 4100000L, 3200000L, 1800000L, 1000000L);

    /* renamed from: u */
    public static final C6685q<Long> f28923u = C6685q.m38438A(2800000L, 2400000L, 1600000L, 1100000L, 950000L);

    /* renamed from: v */
    private static C5844s f28924v;

    /* renamed from: a */
    private final C6690r<Integer, Long> f28925a;

    /* renamed from: b */
    private final C5798f.C5799a.C5800a f28926b;

    /* renamed from: c */
    private final C5832n0 f28927c;

    /* renamed from: d */
    private final C5923d f28928d;

    /* renamed from: e */
    private final boolean f28929e;
    ...
    /* renamed from: v3.s$b */
    /* compiled from: DefaultBandwidthMeter */
    public static final class C5846b {

        /* renamed from: a */
        private final Context f28940a;

        /* renamed from: b */
        private Map<Integer, Long> f28941b;

        /* renamed from: c */
        private int f28942c;

        /* renamed from: d */
        private C5923d f28943d;
        ...
        public C5846b(Context context) {
            ...
            this.f28941b = m34681b(C5953m0.m35094N(context));
            this.f28942c = AdError.SERVER_ERROR_CODE;
            this.f28943d = C5923d.f29058a;
            this.f28944e = true;
        }

        /* renamed from: b */
        private static Map<Integer, Long> m34681b(String str) {
            int[] k = C5844s.m34666l(str);
            HashMap hashMap = new HashMap(8);
            hashMap.put(0, 1000000L);
            C6685q<Long> qVar = C5844s.f28918p;
            hashMap.put(2, qVar.get(k[0]));
            hashMap.put(3, C5844s.f28919q.get(k[1]));
            hashMap.put(4, C5844s.f28920r.get(k[2]));
            hashMap.put(5, C5844s.f28921s.get(k[3]));
            hashMap.put(10, C5844s.f28922t.get(k[4]));
            hashMap.put(9, C5844s.f28923u.get(k[5]));
            hashMap.put(7, qVar.get(k[0]));
            return hashMap;
        }

        /* renamed from: a */
        public C5844s mo20389a() {
            return new C5844s(this.f28940a, this.f28941b, this.f28942c, this.f28943d, this.f28944e);
        }
    }
    ...
    public static int[] m34666l(java.lang.String r3) {
        /*
            r3.hashCode()
            int r0 = r3.hashCode()
            r1 = 6
        ...
        L_0x1078:
            ...
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: p155v3.C5844s.m34666l(java.lang.String):int[]");
    }

    /* renamed from: m */
    private long m34667m(int i) {
        Long l = this.f28925a.get(Integer.valueOf(i));
        if (l == null) {
            l = this.f28925a.get(0);
        }
        if (l == null) {
            l = 1000000L;
        }
    ...
    /* renamed from: n */
    public static synchronized C5844s m34668n(Context context) {
        C5844s sVar;
        synchronized (C5844s.class) {
            if (f28924v == null) {
                f28924v = new C5846b(context).mo20389a();
            }
            sVar = f28924v;
        }
        return sVar;
    ...
    /* renamed from: o */
    private static boolean m34669o(C5837p pVar, boolean z) {
        return z && !pVar.mo20368d(8);
    }

    /* renamed from: p */
    private void m34670p(int i, long j, long j2) {
        if (i != 0 || j != 0 || j2 != this.f28937m) {
            this.f28937m = j2;
            this.f28926b.mo20322c(i, j, j2);
        }
    }
    ...
    /* renamed from: q */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public synchronized void m34671q(int r9) {
        /*
            r8 = this;
            monitor-enter(r8)
            int r0 = r8.f28933i     // Catch:{ all -> 0x0055 }
            if (r0 == 0) goto L_0x000b
            boolean r1 = r8.f28929e     // Catch:{ all -> 0x0055 }
            if (r1 != 0) goto L_0x000b
            monitor-exit(r8)
            return
        L_0x000b:
            boolean r1 = r8.f28938n     // Catch:{ all -> 0x0055 }
            if (r1 == 0) goto L_0x0011
            int r9 = r8.f28939o     // Catch:{ all -> 0x0055 }
        L_0x0011:
            if (r0 != r9) goto L_0x0015
            monitor-exit(r8)
            return
        L_0x0015:
            r8.f28933i = r9     // Catch:{ all -> 0x0055 }
            r0 = 1
            ...
            goto L_0x0053
        L_0x0021:
            long r0 = r8.m34667m(r9)     // Catch:{ all -> 0x0055 }
            r8.f28936l = r0     // Catch:{ all -> 0x0055 }
            w3.d r9 = r8.f28928d     // Catch:{ all -> 0x0055 }
            long r0 = r9.mo20586b()     // Catch:{ all -> 0x0055 }
            int r9 = r8.f28930f     // Catch:{ all -> 0x0055 }
            if (r9 <= 0) goto L_0x0038
            long r2 = r8.f28931g     // Catch:{ all -> 0x0055 }
            long r2 = r0 - r2
        ...
        L_0x0038:
            ...
            r3 = 0
        L_0x003a:
            long r4 = r8.f28932h     // Catch:{ all -> 0x0055 }
            long r6 = r8.f28936l     // Catch:{ all -> 0x0055 }
            r2 = r8
            r2.m34670p(r3, r4, r6)     // Catch:{ all -> 0x0055 }
            r8.f28931g = r0     // Catch:{ all -> 0x0055 }
            r0 = 0
            r8.f28932h = r0     // Catch:{ all -> 0x0055 }
            r8.f28935k = r0     // Catch:{ all -> 0x0055 }
            r8.f28934j = r0     // Catch:{ all -> 0x0055 }
            v3.n0 r9 = r8.f28927c     // Catch:{ all -> 0x0055 }
            r9.mo20361i()     // Catch:{ all -> 0x0055 }
            monitor-exit(r8)
            return
        L_0x0053:
            monitor-exit(r8)
        ...
        L_0x0055:
            ...
            throw r9
        */
        throw new UnsupportedOperationException("Method not decompiled: p155v3.C5844s.m34671q(int):void");
    }

    /* renamed from: a */
    public synchronized void mo20382a(C5828l lVar, C5837p pVar, boolean z) {
        if (m34669o(pVar, z)) {
            C5917a.m34873f(this.f28930f > 0);
            long b = this.f28928d.mo20586b();
            int i = (int) (b - this.f28931g);
            this.f28934j += (long) i;
            long j = this.f28935k;
            long j2 = this.f28932h;
            this.f28935k = j + j2;
            if (i > 0) {
                this.f28927c.mo20359c((int) Math.sqrt((double) j2), (((float) j2) * 8000.0f) / ((float) i));
                if (this.f28934j >= 2000 || this.f28935k >= 524288) {
                    this.f28936l = (long) this.f28927c.mo20360f(0.5f);
                }
                m34670p(i, this.f28932h, this.f28936l);
                this.f28931g = b;
                this.f28932h = 0;
            }
            this.f28930f--;
    ...
    /* renamed from: b */
    public /* synthetic */ long mo20316b() {
        return C5795d.m34530a(this);
    }

    /* renamed from: c */
    public void mo20317c(Handler handler, C5798f.C5799a aVar) {
        C5917a.m34872e(handler);
        C5917a.m34872e(aVar);
        this.f28926b.mo20321b(handler, aVar);
    }

    /* renamed from: d */
    public synchronized void mo20383d(C5828l lVar, C5837p pVar, boolean z) {
        if (m34669o(pVar, z)) {
            if (this.f28930f == 0) {
                this.f28931g = this.f28928d.mo20586b();
            }
            this.f28930f++;
        }
    }
    ...
    /* renamed from: e */
    public void mo20318e(C5798f.C5799a aVar) {
        this.f28926b.mo20323e(aVar);
    }

    /* renamed from: f */
    public C5840p0 mo20319f() {
        return this;
    }

    /* renamed from: g */
    public synchronized long mo20320g() {
        return this.f28936l;
    }

    /* renamed from: h */
    public void mo20384h(C5828l lVar, C5837p pVar, boolean z) {
    }

    /* renamed from: i */
    public synchronized void mo20385i(C5828l lVar, C5837p pVar, boolean z, int i) {
        if (m34669o(pVar, z)) {
            this.f28932h += (long) i;
        }
    }

    private C5844s(Context context, Map<Integer, Long> map, int i, C5923d dVar, boolean z) {
        this.f28925a = C6690r.m38471d(map);
        this.f28926b = new C5798f.C5799a.C5800a();
        this.f28927c = new C5832n0(i);
        this.f28928d = dVar;
        this.f28929e = z;
        if (context != null) {
            C5974y d = C5974y.m35278d(context);
            int f = d.mo20665f();
            this.f28933i = f;
            this.f28936l = m34667m(f);
            d.mo20666i(new C12804r(this));
            return;
        }
        this.f28933i = 0;
        this.f28936l = m34667m(0);
    }
}
